...
residual imperative gate logic (example-doctrine-repo coordinator/skills/percolate/SKILL.md).
...
Spec backlink: coordinator/skills/percolate/SKILL.md (example-doctrine-repo) — Branch 0,
