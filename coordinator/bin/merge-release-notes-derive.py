...
Purpose: example-doctrine-repo's coordinator/skills/merging-to-main/SKILL.md Step 5.5
...
(example-doctrine-repo/CLAUDE.local.md, 2026-07-22), that logic is lifted here as a
...
Subcommands:
  ...
  flip-tags <release_tag_cut> <merge_sha> <merge_date> <entry_path>...
      ...
      of coordinator/skills/merging-to-main/SKILL.md in example-doctrine-repo for the
      pre-port original.
