# publish-emission.ps1 — python-direct Windows launcher for publish-emission.py (NO bash re-exec).
...
#   - On bare-name resolution, PowerShell prefers this "publish-emission.ps1" file over
#     any co-located "publish-emission.cmd" sibling -- `publish-emission` typed bare in a pwsh
...
#
# Resolves a Python interpreter and runs the co-located entrypoint "publish-emission.py"
...
$_entry = Join-Path $_here 'publish-emission.py'
...
[Console]::Error.WriteLine('[publish-emission] ERROR: no Python interpreter found (python.exe / py -3).')
[Console]::Error.WriteLine('[publish-emission] Install Python: https://www.python.org/downloads/windows/')
exit 127
