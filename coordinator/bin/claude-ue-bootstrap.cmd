@echo off
setlocal
REM Windows launcher for claude-ue-bootstrap.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "claude-ue-bootstrap.ps1" sibling of
REM     this file over this "claude-ue-bootstrap.cmd" file itself -- if both exist, `claude-ue-bootstrap`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "claude-ue-bootstrap.py"
...
echo [claude-ue-bootstrap] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [claude-ue-bootstrap] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0claude-ue-bootstrap.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0claude-ue-bootstrap.py" %*
exit /b %ERRORLEVEL%
