...
App-Execution-Alias stub detection) -- so example-doctrine-repo's
...
in example-doctrine-repo (see cross-repo/archive/2026-07-23-example-doctrine-repo-em-four-new-bin-
...
Example-doctrine-repo found zero references to `probe-prereq` or `bash-version` outside
...
Spec backlink: coordinator/commands/install.md (example-doctrine-repo) § 1a.3 (git-lfs
