...
`/percolate` skill's (example-doctrine-repo coordinator/skills/percolate/SKILL.md)
...
Spec backlink: coordinator/skills/percolate/SKILL.md (example-doctrine-repo) — Step 2,
