...
Test seam (internal, not part of the ceremony contract):
  ...
  These exist so bin/tests/test-coordinator-daily-branch.sh (AC5/AC6; example-doctrine-repo 2fbe0e77,
...
Port of: workday-start-step0.sh (example-doctrine-repo 091c0f3e, 2026-07-19). `today` is
natively imported from coordinator_core.daily_day.local_day (de-bash campaign,
2026-07-21 — Port of: coordinator-daily-day.sh, example-doctrine-repo c6d97219, 2026-07-22;
...
session-ensure-branch.sh, example-doctrine-repo 9cc1d315, 2026-07-21). sync-main.py and
...
# (replaces the retired coordinator-daily-branch.sh bash-lib bridge, example-doctrine-repo 2fbe0e77, 2026-07-19)
# ---------------------------------------------------------------------------
