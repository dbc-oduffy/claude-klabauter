...
against example-retrieval-repo's on-disk planes or the filesystem — never by model
...
Zero model dispatches. Zero subprocess fan-out. Opens example-retrieval-repo's SQLite
...
- Does NOT write to any example-retrieval-repo database. Read-only connections only.
...
# ---------------------------------------------------------------------------
# example-retrieval-repo plane access — strictly read-only
# ---------------------------------------------------------------------------
