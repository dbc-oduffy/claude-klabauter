...
bash implementation (render-template-tree.sh, example-doctrine-repo 290997c7, 2026-07-22 —
...
test_render_template_tree.py. This file is now a thin example-doctrine-repo-side (contract)
...
Claude-klabauter module shells out to it by resolving the example-doctrine-repo clone root and locating
