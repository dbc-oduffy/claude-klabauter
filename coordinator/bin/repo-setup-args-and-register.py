...
logic previously embedded in example-doctrine-repo's `coordinator/skills/repo-setup/SKILL.md`.
...
Spec backlink: example-doctrine-repo coordinator/skills/repo-setup/SKILL.md
