...
Converted from a hand-rolled runner (`migrate-improvement-queue-project.test.py`) to a
pytest-collectable module — the module was already unittest.TestCase-shaped, so this is a
rename plus removal of the `unittest.main()` harness (pytest collects the TestCase classes
directly).
