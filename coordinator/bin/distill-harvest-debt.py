...
distillation log (run|path|disposition|fate; ASCII "->") — plus the example-doctrine-repo schema-header
...
harvest-debt list — for the example-doctrine-repo distill Workflow/skill to consume.
