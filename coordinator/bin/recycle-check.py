...
Measured on example-retrieval-repo, wave 0 of run 20260910T064533Z: 27 batons, 5 carrying an execution record
...
def _disposition(text: str) -> tuple[str, str]:
    ...
    if word in _TERMINAL_OUTCOMES:
        ...
        # tree does not show. Measured on example-retrieval-repo-ue-addon: an XS verified two of four next
