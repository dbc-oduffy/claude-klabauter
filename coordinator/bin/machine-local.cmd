...
REM   - On bare-name resolution, PowerShell prefers a "machine-local.ps1" sibling of
REM     this file over this "machine-local.cmd" file itself -- if both exist, `machine-local`
