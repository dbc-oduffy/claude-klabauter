...
Port of: workday-complete-step3-consolidate.sh (example-doctrine-repo 091c0f3e, 2026-07-19).
...
unit "daily-branch" — Port of: coordinator-daily-branch.sh, example-doctrine-repo 2fbe0e77, 2026-07-19, see
