...
out of example-doctrine-repo's `coordinator/skills/merging-to-main/SKILL.md` Step 1 /
...
skill-side repoint (D2) is a later wave and lands in example-doctrine-repo, not here.
...
Spec backlink: example-doctrine-repo coordinator/skills/merging-to-main/SKILL.md Step 1
