...
WHY IT MATTERS MORE THAN ORDINARY DRIFT. Example-retrieval-repo's exclusion globs are read at the corpus
...
`test_starter_projectragignore_completeness.py` under EXAMPLE-RETRIEVAL-REPO-IGNORE-SCAFFOLD-PARITY.)
