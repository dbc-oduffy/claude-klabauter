...
COORDINATOR_BIN_ROOT (test isolation for the example-doctrine-repo-side sibling-script root).

Spec backlink: docs/plans/2026-07-15-bash-to-naked-python-engine-migration.md § T3a-g2/T3b
Port of: coordinator-doctor-sentinel.sh (example-doctrine-repo b5a4192c, 2026-07-20; 989-line bash oracle)
"""
...
def _import_main():
    ...
    coordinator/bin/) so sentinel.py's example-doctrine-repo-side sibling-script resolution
