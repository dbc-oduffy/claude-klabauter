...
python-trampolines.md in the example-doctrine-repo clone, not this repo; the path is
...
Spec backlink: state/audits/2026-07-20-sh-suffixed-python-trampolines.md
  (example-doctrine-repo clone — see the citation above for why this path does not
