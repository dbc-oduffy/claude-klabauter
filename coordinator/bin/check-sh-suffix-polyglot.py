...
python-trampolines.md in the coordinator-claude clone, not this repo; the path is
...
Spec backlink: state/audits/2026-07-20-sh-suffixed-python-trampolines.md
  (coordinator-claude clone — see the citation above for why this path does not
