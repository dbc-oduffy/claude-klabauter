...
normalize_consumed_frontmatter per DR-084), and this file is a thin example-doctrine-repo-side
...
# node oracle's own module — this file is a thin example-doctrine-repo-side
# (contract) trampoline over that engine module, per DR-047 (example-doctrine-repo owns
# contract/generator, claude-klabauter owns engine), following the refresh-queries.py
# precedent: engine in claude-klabauter, thin example-doctrine-repo trampoline, no subprocess re-spawn
