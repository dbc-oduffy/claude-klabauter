...
def _yaml_quote_string(value: str) -> str:
    ...
    lesson/improvement-queue corpus (example-retrieval-repo-em's fleet_prose unparseable-YAML
    report, 2026-08-11).
    """
    if not value:
        return '""'
...
def main() -> None:
    ...
    if schema_name in _WORKSTREAM_STORE_SCHEMAS:
        ...
        # Fixes cross-repo memo 2026-08-11-example-retrieval-repo-em-queue-append-required-fields-undiscoverable.md
