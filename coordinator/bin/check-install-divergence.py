...
Lifted verbatim-on-contract 2026-05-28 from:
  X:/example-retrieval-repo/example_retrieval_repo_scripts/lib/check_install_divergence.py
...
Named consumers (cross-repo contract commitments):
  ...
  - example-retrieval-repo-ue-addon (sentinel-only adopter via separable
