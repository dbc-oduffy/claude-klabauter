...
advancing (the in-artifact halt field is blocked behind example-doctrine-repo's
...
- `emit-cockpit-snapshot.py` — refreshes after a successful on-demand emission to
  ...
  emission is the standing offer made to example-cockpit-repo and example-retrieval-repo under
