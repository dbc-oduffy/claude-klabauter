...
fences in `coordinator/skills/learn-lessons/SKILL.md` (coordinator-claude) so the skill can
...
Spec backlink: coordinator/skills/learn-lessons/SKILL.md (coordinator-claude)
