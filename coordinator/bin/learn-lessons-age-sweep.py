...
fences in `coordinator/skills/learn-lessons/SKILL.md` (example-doctrine-repo) so the skill can
...
Spec backlink: coordinator/skills/learn-lessons/SKILL.md (example-doctrine-repo)
