...
# Port of: prune-resolved-queue-entries.sh (example-doctrine-repo b5a4192c, 2026-07-20) — the
#          8-rule awk program's fixture-diff regression net
#          (prune-resolved-queue-entries.test.sh, example-doctrine-repo 3a561713, 2026-07-22)
