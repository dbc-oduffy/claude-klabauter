...
fences embedded in example-doctrine-repo's coordinator/skills/validate/SKILL.md ("How to
...
Why this exists as one file, not two: the example-doctrine-repo ceremony step (/validate)
...
Port source: coordinator/skills/validate/SKILL.md (example-doctrine-repo) -- "How to
...
here -- those are the D1/D2 repoint's concern (the example-doctrine-repo-side caller resolves
