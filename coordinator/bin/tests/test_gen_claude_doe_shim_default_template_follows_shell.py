...
Regression origin: the example-doctrine-repo memo of 2026-08-13 (PowerShell shim landed).
...
class TestBothTemplatesExistOnDisk(unittest.TestCase):
    """The `.ps1.tmpl` default is only correct because example-doctrine-repo ships the
