...
_LEGACY_UNVERIFIED_ENTRYPOINTS = frozenset({
    ...
    "audit-roadmap.py",
    "autonomous-verb.py",
    "backfill-deliverable-spine.py",
    "backfill-initiative-fk.py",
    ...
    "install-claude-klabauter-precommit-hook.py",
    ...
    "migrate-state-to-claude-klabauter.sh",
