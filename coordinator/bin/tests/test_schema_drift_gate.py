...
def _load_module():
    """Import coordinator/bin/schema-drift-gate (extensionless) as a fresh module object.
    ...
    """
    path = os.path.join(BIN_DIR, "schema-drift-gate")
...
def _run_main_capturing(mod, argv=None, fake_route=None, fake_repo_root="/tmp/fake-repo"):
