...
co-located test_assert_no_dangling_plan_backlinks.py) per DR-047 (example-doctrine-repo owns
contract/generator, claude-klabauter owns engine). This file is now a thin example-doctrine-repo-side
