...
exists at `~/.claude/docs/wiki/<name>.md`. Part of the example-doctrine-repo-owns-contract /
...
# coordinator_core/ops/test_sync_plugin_wiki.py. This file is now a thin example-doctrine-repo-side
