...
| `bin/render-handoff-tracker.js:521` | `path.join(os.homedir(), '.claude', 'state', 'doe-handoff-tracker.md')` | CENTRAL | JS form; direct `$HOME/.claude/state` ref; coordinator-claude `--all-repos` mode only |
