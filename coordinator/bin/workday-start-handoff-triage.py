...
inline as embedded fences in example-doctrine-repo's `coordinator/commands/workday-start.md`
...
belongs to).
Port of: example-doctrine-repo coordinator/commands/workday-start.md § Step 0.8 (Stale-
