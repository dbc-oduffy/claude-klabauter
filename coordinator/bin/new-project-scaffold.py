...
coordinator_core.ops.new_project_scaffold; this file is a thin example-doctrine-repo-side
...
# test_new_project_scaffold.py. This file is now a thin example-doctrine-repo-side (contract)
...
# (bad args, occupied target dir), a missing/unresolvable example-doctrine-repo-side template
