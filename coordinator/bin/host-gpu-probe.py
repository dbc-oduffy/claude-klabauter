...
Example-retrieval-repo and example-game-repo were asked directly which they still need, and both independently
...
installed and working, and neither example-retrieval-repo nor example-game-repo has a live caller that reads its
...
module, never an importable package: example-retrieval-repo's contract bans importing whoami-shaped
...
Known example-retrieval-repo consumers: install_example_retrieval_repo_plugin.py:2045 (torch/CUDA wheel selection),
