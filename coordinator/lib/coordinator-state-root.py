...
bridge shape (DR-047: example-doctrine-repo owns contract, claude-klabauter owns engine).
...
Port of: coordinator-state-root.sh (example-doctrine-repo 6fb5fb37, 2026-07-22, bash sourced-lib oracle)
