@echo off
setlocal
REM Windows launcher for coordinator-postsync-marker-resync-check — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "coordinator-postsync-marker-resync-check.ps1" sibling of
REM     this file over this "coordinator-postsync-marker-resync-check.cmd" file itself -- if both exist, `coordinator-postsync-marker-resync-check`
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "coordinator-postsync-marker-resync-check"
...
echo [coordinator-postsync-marker-resync-check] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [coordinator-postsync-marker-resync-check] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0coordinator-postsync-marker-resync-check" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0coordinator-postsync-marker-resync-check" %*
exit /b %ERRORLEVEL%
