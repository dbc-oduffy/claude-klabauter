...
Negative-spec (2026-07-21): this suite no longer exercises src/ or dist/ — upstream DoE
...
def _init_fake_clone(path: Path) -> None:
    """Initialise a bare-bones git repo for use as a fake DoE clone."""
...
def base_fake_clone(tmp_path: Path):
    """Fake DoE clone with v2.4.0 schema committed; returns (clone_path, sha_v240).
