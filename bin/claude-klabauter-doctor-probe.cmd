@echo off
setlocal
REM Windows launcher for claude-klabauter-doctor-probe.py — python-direct (NO bash re-exec).
...
REM   - On bare-name resolution, PowerShell prefers a "claude-klabauter-doctor-probe.ps1" sibling of
REM     this file over this "claude-klabauter-doctor-probe.cmd" file itself -- if both exist, `claude-klabauter-doctor-probe`
...
echo [claude-klabauter-doctor-probe] ERROR: no Python interpreter found (python.exe / py -3). 1>&2
echo [claude-klabauter-doctor-probe] Install Python: https://www.python.org/downloads/windows/ 1>&2
exit /b 127
...
:run_baked
"%_py%" "%~dp0claude-klabauter-doctor-probe.py" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0claude-klabauter-doctor-probe.py" %*
exit /b %ERRORLEVEL%
