@echo off
setlocal
REM Windows launcher for claude-klabauter-commit-anchors — python-direct (NO bash re-exec).
...
REM
REM Resolves a Python interpreter and runs the co-located entrypoint "claude-klabauter-commit-anchors"
...
:run_baked
"%_py%" "%~dp0claude-klabauter-commit-anchors" %*
exit /b %ERRORLEVEL%

:run_py3
py -3 "%~dp0claude-klabauter-commit-anchors" %*
exit /b %ERRORLEVEL%
