...
Purpose: C4-C7 (docs/plans/2026-07-26-gate-resolution-widen-and-migrate.md, example-doctrine-repo)
...
baton in example-doctrine-repo, claude-klabauter, example-cockpit-repo, example-retrieval-repo, and
...
REPO_KEYS: Tuple[Tuple[str, str], ...] = (
    ("repos.example_doctrine_repo", "example-doctrine-repo"),
...
#: and-migrate.md's follow-on, example-doctrine-repo) adds a `contradiction` key to
