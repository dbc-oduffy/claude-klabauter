...
Spawn ratchet C2 disposition: TIER -- "importing X registers no ops" is
meaningless once this process has already imported the tree; a clean
interpreter is the property under test, not incidental.
"""
