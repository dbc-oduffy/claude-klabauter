...
(Write|Edit|MultiEdit|NotebookEdit) hook (deleted 2026-07-16, DoE
...
(``archive-stamp-cli ship-handoff`` — DoE's ergonomic veneer over
...
DoE-side in b22f973d). A third named route, in the continuation branch
...
Spec backlink: coordinator/hooks/scripts/block-consumed-handoff-edit.sh (header doc,
  retired 2026-07-16, DoE ``2f8b8450``)
Ported from the retired DoE bash guard ``block-consumed-handoff-edit.sh``
