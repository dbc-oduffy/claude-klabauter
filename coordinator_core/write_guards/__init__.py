...
Python engine-ification of example-doctrine-repo's per-edit bash guard fan-out
...
Example-doctrine-repo owns the thin plumbing (a single python3 PreToolUse dispatcher that imports
