...
(Write|Edit|NotebookEdit|MultiEdit) hook (deleted 2026-07-16, example-doctrine-repo
...
Ported from the retired example-doctrine-repo bash guard ``block-completion-monolith-write.sh``
