...
Ported from example-doctrine-repo `coordinator/hooks/scripts/guard-settings-json-write.py`
...
commands pointing at `X:/example-doctrine-repo/...` -- a Windows drive path on a macOS
