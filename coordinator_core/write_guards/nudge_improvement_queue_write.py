...
Originally an engine-ification of example-doctrine-repo's retired
``coordinator/hooks/scripts/nudge-improvement-queue-write.sh`` PreToolUse
(Write|Edit|MultiEdit) hook (deleted 2026-07-16, example-doctrine-repo ``2f8b8450``). That
fidelity claim is now VOID (2026-07-30 escape-mechanism rework): example-doctrine-repo no
