...
MEMO_SCHEMA_BUMP_NOTE = (
    ...
    "resorts to a per-file `git log --follow` proxy. Requested by a consumer repo "
    "2026-09-04 (memo memo-closure-timestamp-missing-from-cross-repo-memo-summary.md, "
    "their commit 8754b2171); "
