"""coordinator_core.contract.memo_conformance -- coordinator-claude-contract conformance gate for the
...
executable-surface migration, no longer coordinator-claude-hosted and never vendored -- plus
CONTRACT-VS-ERGONOMIC.md, the classification of which
of the coordinator-claude CLI's own tests are contract-invariant (must survive the cutover) versus
