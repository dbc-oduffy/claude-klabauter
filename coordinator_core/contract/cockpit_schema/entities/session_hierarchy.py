"""
SessionHierarchy — pydantic port of example-doctrine-repo
...
class SessionHierarchy(BaseModel):
    ...
    # field. NOT a workstream identity per the example-voice-system invariant.
    branch: str | None
    ...
    # Omitted by claude-klabauter for records with no resolvable single source file
