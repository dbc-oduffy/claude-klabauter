...
class InitiativeSummary(BaseModel):
    ...
    # Stable kebab-case id for this initiative, e.g. "ini-example-fleet-os-bet".
    ...
    # Goal refs for the goals→initiatives→status ladder (cockpit buildLadder
    # reads it defensively). Version-neutral optional — absent on all
    # existing records (2.13.0, D24). "Defensively" means cockpit handles an
