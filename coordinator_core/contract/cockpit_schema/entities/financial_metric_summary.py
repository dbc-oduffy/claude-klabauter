...
Pydantic port of example-doctrine-repo `coordinator/cockpit-contract/src/entities/financial-metric-summary.ts`
...
bilateral by construction — example-doctrine-repo ratifies the shape, claude-klabauter's emitter produces
