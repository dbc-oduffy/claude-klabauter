...
class RoadmapSummary(BaseModel):
    ...
    Spec backlinks:
      ...
      example-retrieval-repo/cross-repo/archive/2026-07-05-roadmap-dag-emit-rag-query-seam.md
    ...
    has the maximum length. Derived at emit by claude-klabauter's roadmap_dag.py; null
