"""
coordinator_core.distill.wiki_log_migrate — one-time RETIREMENT of claude-klabauter's legacy
...
reflection was pointing at (cockpit's premise that "DoE has two logs" is wrong; DoE's
