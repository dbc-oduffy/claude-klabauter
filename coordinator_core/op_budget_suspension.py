...
SUSPENDED_OPS: Dict[str, Dict[str, object]] = {
    ...
    "deliverable.cascade_terminal": {
        ...
        "disposition": (
            ...
            "corpus -- both over the 200ms bar. FIX LANDED 2026-08-30 "
            ...
            "same live 303-file corpus (C3's process-time suite, 5/5 runs GREEN): "
            "62.5-78.1ms, under the 200ms bar, with the collapsed and baseline arms "
