...
another. No subprocess anywhere.
...
_PROBES: Dict[str, Callable[[Mapping[str, str]], Capability]] = {
...
def has(name: str, env: Optional[Mapping[str, str]] = None) -> bool:
    return capability(name, env).value
