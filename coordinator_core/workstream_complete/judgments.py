...
complete/SKILL.md` (example-doctrine-repo) extracts every genuinely mechanical branch
...
three-tier model, example-doctrine-repo): every builder below carries a
...
chunk C2f. Census: example-doctrine-repo
...
def build_memo_resolution_attribution_judgment_point(
    ...
    example-doctrine-repo-em-wsc-review-trail-passthrough-and-memo-attribution.md`):
...
def build_stage_paths_missing_judgment_point(
    ...
    33e5cdf24112.yaml, example-doctrine-repo).
...
# ---------------------------------------------------------------------------
# No-commit row disposition (example-doctrine-repo docs/plans/2026-07-29-pm-approved-
...
def build_no_commit_row_disposition_judgment_point(
    ...
    relaxed at example-doctrine-repo `bd0475fd5`/schema 1.4.0 -- no PM word), backlogged
    ...
    return build_judgment_point(
        ...
        reason=(
            ...
            "relaxed at example-doctrine-repo bd0475fd5/schema 1.4.0), backlogged and wont-do "
            "each require a PM word (retained by PM ruling -- cross-repo/inbox/"
            "2026-08-05-example-doctrine-repo-em-plan-tasks-five-exits-ruling.md), and "
