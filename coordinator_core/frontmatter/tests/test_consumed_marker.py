...
Spec backlink: example-doctrine-repo coordinator/bin/lib/consumed-marker.js.
"""
...
# diverge DELIBERATELY from the JS original (example-doctrine-repo lib/consumed-marker.js),
