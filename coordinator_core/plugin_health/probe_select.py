...
no longer the directory the manifest actually lives in (the manifest is DoE-side data,
...
def _default_manifest_path() -> Path:
    ...
    DOCTOR_PROBES_MANIFEST override), else the historical DoE bin/ location.
    CLI-mode callers that need a real doctor-probes.toml should always pass
    manifest_path explicitly (the DoE trampoline knows its own sibling-file
