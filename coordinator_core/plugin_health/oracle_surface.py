...
Example-doctrine-repo-cited demand minus live claude-klabauter oracles) and `bin_inventory_gate.py`
...
Example-doctrine-repo's own citation (blind to `fleet_reachability`) AND absent from an
