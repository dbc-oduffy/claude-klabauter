...
def test_external_old_repo_entry_does_not_dispose_future_disappearance(tmp_path: Path) -> None:
    ...
    (`old_repo: "coordinator-claude (example-doctrine-repo)"`), which records a
    example-doctrine-repo -> claude-klabauter adoption, not a claude-klabauter-internal move -- so its
