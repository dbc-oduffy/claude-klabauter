...
Example-doctrine-repo coordinator/bin/lib/read-mirrors.sh — see that module's docstring).
...
Port of: read-mirrors.sh::_read_all_mirrors (example-doctrine-repo 721a71f4, 2026-07-21)
"""
