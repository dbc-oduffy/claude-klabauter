...
Pytest port of example-doctrine-repo coordinator/bin/check-plugin-drift.test.sh — the Leg-3
...
Port of: check-plugin-drift.test.sh (example-doctrine-repo 15f58741, 2026-07-16)
"""
