...
(example-doctrine-repo 243b9a7c, 2026-07-19).
...
Port of: coordinator-archive-stamp.sh (example-doctrine-repo 243b9a7c, 2026-07-19; 977 lines, 11 functions).
Example-doctrine-repo veneer: coordinator/bin/archive-stamp-cli (polyglot trampoline calling this module).
...
Function-to-oracle map:
    ...
    cs_repair_archived_deployment_state <- NEW, no bash-oracle predecessor (calls
                                                                 ...
                                                                 example-doctrine-repo cross-repo memo
...
Negative-spec:
    ...
    - cs_action_memo's session-shape actioned_memos write has NO native
      ...
      subprocess bridge. Retired the example-doctrine-repo-root-pointer bash-lib resolution
...
def _mechanical_commit_denylist() -> Sequence[str]:
    ...
    SAME example-doctrine-repo-owned policy YAML `coordinator_core.reconcile.commit_reality`'s own
...
def stamp_shipped_in(
    ...
    *,
    ...
    kind: REQUIRED, keyword-only, no default (DR-096, example-doctrine-repo 2026-07-26 ruling —
...
def cs_ship_handoff(
    ...
    via example-doctrine-repo's archive-stamp-cli) included — gets the SAME unconditional
...
def cs_repair_archived_deployment_state(
    ...
    above. Added 2026-07-26 after a example-doctrine-repo cross-repo memo reported 13
    ...
    13 example-doctrine-repo hand-edits did exactly this).
