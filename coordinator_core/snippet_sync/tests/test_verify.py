...
Example-doctrine-repo-side registry.toml + snippets/) is verified separately at build time
...
don't depend on the sibling example-doctrine-repo checkout's exact file layout.
...
def test_residual_comment_fragment_would_have_caught_doe_incident():
    """Demonstrates the example-doctrine-repo 2026-07-25 incident shape directly: reconstruct
...
# ---------------------------------------------------------------------------
# ORPHAN-SENTINEL DETECTION (2026-07-25 example-doctrine-repo incident — see the
...
# `(synced from ...)` clause, which is why example-doctrine-repo's exact-match grep missed it),
...
# ---------------------------------------------------------------------------
# delivery = "inject" enforcement (registry schema_version 3, example-doctrine-repo 7ff1cb75e;
# answer memo cross-repo/inbox/2026-07-28-example-doctrine-repo-em-delivery-field-answer.md).
#
