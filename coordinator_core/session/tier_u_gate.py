...
Spec backlink: cross-repo/archive/2026-07-25-example-doctrine-repo-em-validate-tier-u-
shape-ruling.md (R3, R4) -- amendment to
docs/decisions/DR-088-test-breadth-ladder-tiered-invocation-authority.md.
R6/R7 amendment: cross-repo/archive/2026-07-25-example-doctrine-repo-em-dr088-marker-
scope-ruling.md.
...
Negative-spec:
  ...
  - Does NOT implement tie-detection between ``fast_test_cmd`` and
    ...
    ruling memo's "do not detect a tie" section: example-doctrine-repo legitimately
