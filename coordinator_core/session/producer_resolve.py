...
Spec backlink (op_identity is ours to resolve, not read back): cross-repo/inbox/
    2026-08-12-example-doctrine-repo-em-producer-axis-batch-normalize-back-stamp.md
...
def resolve_producer_for_creation(
    *, op_identity: str, cwd: Optional[str] = None
    ...
    is deliberately NOT validated against example-doctrine-repo's 46-member command vocabulary:
    that vocabulary is declared single-point-of-truth in example-doctrine-repo's own repo with
