...
_ALLOWED: Dict[Tuple[str, str, str, str, str, int], str] = {
    ...
    ("coordinator_core", "hooks/postuse_advisory_dispatch.py", "_check_unrecognised_sonnet_generation", "os.replace", "os.replace(tmp_path, path)", 1): "atomic tmp->final; temp source never claimed",
    ...
    ("coordinator_core", "ops/coverage_gate.py", "_write_artifact", "os.replace", "os.replace(tmp_str, str(artifact_path))", 1): "atomic tmp->final rename; temp source never claimed",
    ("coordinator_core", "ops/completion_ops.py", "reconcile_completion_commits", "os.replace", "os.replace(tmp_path, str(path))", 1): "atomic tmp->final rename; temp source never claimed",
    ...
    ("coordinator_core", "ops/ceremony/tail_ops.py", "render_handoff_tracker", "os.replace", "os.replace(tmp_path_str, str(out_path))", 1): "atomic tmp->final; temp source never claimed",
    ...
    ("coordinator_core", "ops/ceremony/ceremony_lock.py", "_stamp_holder", "os.replace", "os.replace(str(tmp_path), str(holder_file))", 1): "atomic tmp->final AND source lives under the .git-rooted lock root, outside claimable space either way",
    ("coordinator_core", "ops/ceremony/ceremony_lock.py", "_stamp_holder", "os.replace", "os.replace(str(tmp_sid_path), str(session_id_file))", 1): "atomic tmp->final AND source lives under the .git-rooted lock root, outside claimable space either way",
    ...
    ("coordinator_core", "session/review_trail_vouch.py", "write_review_trail_vouch", "os.replace", "os.replace(tmp_name, grant_file)", 1): "atomic tmp->final rename; temp never claimed, destination under .git/",
    ...
    ("bin", "publish.py", "_swap_publish_staging_into_dest", "os.rename", "os.rename(dest_git, staging_dir / '.git')", 1): "dest_dir points at an external sibling-repo publish destination, outside this worktree entirely",
