...
constant consumed by claude-klabauter's own Check 7 cannot live in a DoE hook script).
...
leave under it (DoE's hook: 100-byte margin; claude-klabauter's Check 7: 2000-byte
