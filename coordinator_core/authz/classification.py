...
OP_CLASSIFICATION: types.MappingProxyType[str, OpClass] = types.MappingProxyType({
    ...
    # default holds until a future chunk does that per-op work and reclassifies
    # any that qualify, same posture as every other unaffirmed row in this file.
    ...
    "hooks.guard_python_syntax_on_write": OpClass.MUTATING,
    "hooks.guard_posix_invocation_doctrine_write": OpClass.MUTATING,
    ...
    "hooks.guard_host_subagent_bash_ban": OpClass.MUTATING,
    "hooks.guard_host_subagent_bash_spawn_shapes": OpClass.MUTATING,
    "hooks.preuse_bash_dispatch": OpClass.MUTATING,
    "hooks.block_workflow_foreign_emission": OpClass.MUTATING,
    "hooks.block_workflow_unmodeled_agent": OpClass.MUTATING,
    "hooks.allow_emitted_workflow_fire": OpClass.MUTATING,
    "hooks.nudge_workflow_authoring_trampoline": OpClass.MUTATING,
    "hooks.nudge_multiwave_workflow": OpClass.MUTATING,
    "hooks.block_dispatch_suite_invocation": OpClass.MUTATING,
    "hooks.strip_worktree_isolation": OpClass.MUTATING,
    "hooks.block_worktree_tool": OpClass.MUTATING,
    "hooks.sessionstart_dispatch": OpClass.MUTATING,
    "hooks.sessionstart_async_dispatch": OpClass.MUTATING,
    "hooks.assert_em_role": OpClass.MUTATING,
    "hooks.session_start_watch_presence": OpClass.MUTATING,
    ...
    "hooks.sessionstart_ensure_http_forwarder": OpClass.MUTATING,
    "hooks.guard_hook_generation_self_probe": OpClass.MUTATING,
    "hooks.session_start_guard_plane_check": OpClass.MUTATING,
    "hooks.project_orientation": OpClass.MUTATING,
    "hooks.pickup_autofire": OpClass.MUTATING,
    "hooks.mise_autofire": OpClass.MUTATING,
    "hooks.handoff_segment_inject": OpClass.MUTATING,
    "hooks.group_em_autofire": OpClass.MUTATING,
    "hooks.nudge_initiative_goals_ladder": OpClass.MUTATING,
    "hooks.offer_exploration_tier_dispatch": OpClass.MUTATING,
    "hooks.observe_config_change": OpClass.MUTATING,
    "hooks.observe_post_compact": OpClass.MUTATING,
    "hooks.postuse_stop_family_dispatch": OpClass.MUTATING,
    "hooks.sessionend_auto_commit": OpClass.MUTATING,
