...
lives in a repo-root sentinel checked by example-doctrine-repo-side hooks, not here -- this
...
guard-files.yaml` (example-doctrine-repo) for the incident. Anti-bypass: an interpreter
...
Spec: fleet-wide structural git-worktree ban, main-loop leg (example-doctrine-repo
...
def check(payload: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    # denies-documents-naming-guard-files.yaml` in example-doctrine-repo). Anti-bypass:
