...
def test_position_load_bearing_denylist_deletion_brief(repo):
    """The false-positive class example-doctrine-repo flagged: an executor brief quoting the
...
# whole-prefix. Repro: cross-repo/inbox/2026-07-25-example-doctrine-repo-em-dispatch-
...
# consumer (example-doctrine-repo's block-dispatch-suite-invocation.py) has nothing to see.
# ---------------------------------------------------------------------------
...
def test_classify_text_no_match_re_verify_settled_claims_repro(repo):
    ...
    blast-radius-wide repo sentinel or an env var, and example-doctrine-repo's consumer gates
...
# frames ("they stated"). The downstream consumer (example-doctrine-repo's
...
# intelligence-em-dispatched-agent-scoped-test-breadth.md, example-doctrine-repo repo)
#
