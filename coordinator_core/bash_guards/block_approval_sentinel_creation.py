...
def _deny_reason(cmd: str, reason_kind: str, reason_class: str) -> str:
    ...
    if reason_class == REASON_INDIRECTION:
        ...
        return (
            ...
            "approval sentinel. This guard denies every shape of this "
            "kind by construction, regardless of what the payload "
            "actually does, because one level of interpreter indirection "
            "is a confirmed bypass for this guard's direct rules.\n\n"
            "Detected shape: %s\n\n"
