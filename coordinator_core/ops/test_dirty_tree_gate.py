...
Oracle: test-dirty-tree-gate.sh (example-doctrine-repo 894d4bc6, 2026-07-22)
"""
...
def isolated_plugin_root(tmp_path, monkeypatch):
    """Point CLAUDE_PLUGIN_ROOT at the real example-doctrine-repo coordinator/ checkout.
    ...
    straight at the sibling example-doctrine-repo repo's coordinator/ tree.
    """
    ...
    if not doe_coordinator or not Path(doe_coordinator).is_dir():
        pytest.skip("sibling example-doctrine-repo/coordinator checkout not found")
