...
Package marker for the claude-klabauter-side extraction of coordinator-claude's ``coordinator-doc-new``
...
Oracle (byte-identity target): /coordinator/bin/coordinator-doc-new in the coordinator-claude
