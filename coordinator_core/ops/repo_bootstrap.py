...
(`self_dir`, a example-doctrine-repo-trampoline-supplied sibling-file directory) has no meaning
here; this op has no example-doctrine-repo-side trampoline in its call chain. Per the plan's
