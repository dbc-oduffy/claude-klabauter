...
Purpose: the DR-228 § D6 scratch-tier writer example-doctrine-repo's memo asks for
...
Reply fields:
    ...
    oversized reply that broke example-doctrine-repo's pipeline (a ~515KB body their harness
...
#: unconditional bump: example-doctrine-repo's forward-version fail-loud consumer declines any
...
def build_chunk_table_artifact(
    ...
    *,
    ...
    (cross-repo/inbox/2026-08-06-example-doctrine-repo-em-cartography-chunk-table-
