...
already enforces claude-klabauter's own `CONTRACT_VERSION` against the vendored schema bundle's
...
"the bundle is stale" signal. See the 2026-07-22 example-cockpit-repo-em cross-repo memo
