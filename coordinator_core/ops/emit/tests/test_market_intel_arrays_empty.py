...
class TestValidatesAgainstVendoredV2170Schema:
    ...
    @pytest.mark.xfail(
        reason=(
            ...
            "DELIBERATELY unregistered pending coordinator-claude-canonical-first promotion — registering it "
            "locally would force a cross-repo coordinator-claude-side commit-closure.schema.json and trip the "
