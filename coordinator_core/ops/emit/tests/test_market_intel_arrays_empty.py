...
class TestValidatesAgainstVendoredV2170Schema:
    ...
    @pytest.mark.xfail(
        reason=(
            ...
            "DELIBERATELY unregistered pending example-doctrine-repo-canonical-first promotion — registering it "
            "locally would force a cross-repo example-doctrine-repo-side commit-closure.schema.json and trip the "
