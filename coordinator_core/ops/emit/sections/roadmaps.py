...
Port of: emit-cockpit-snapshot.sh (example-doctrine-repo 07eedcfb, 2026-07-19) § SECTION 8.8 —
  RoadmapSummary. Byte/semantic parity port.
Spec backlink: docs/plans/2026-07-04-tc3-emission-stack-python-port-and-backlog-history.md § P12
Spec backlink: docs/plans/2026-07-06-roadmap-dag-emit-switch.md § C2
