...
update-docs / bug-sweep commit (ONE depth-capped ``git log`` for both — owned by
``coordinator_core.git.commit_delta :: _commits_since_last_batch``, which this module
only calls), a static "unknown" dormant-repo placeholder
...
from coordinator_core.git.commit_delta import _commits_since_last_batch
