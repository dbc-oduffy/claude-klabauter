...
Mirrors the example-doctrine-repo bash test suite case for case -- the bash suite's case
matrix is the parity oracle for this port.

Port of: test-detect-onboarding-offer.sh (example-doctrine-repo 432e3285, 2026-07-22)
"""
