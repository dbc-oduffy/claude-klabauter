...
Trust guard: before delegating, resolves and trust-checks the example-doctrine-repo
...
Port of: refresh-roadmap-callout.sh (example-doctrine-repo a1a568d2, 2026-07-22)
