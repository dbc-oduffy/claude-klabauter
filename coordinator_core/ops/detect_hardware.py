...
(DOE-PORT R2-R6, variant #1 — pristine, no registered op, example-doctrine-repo keeps the .sh filename as
...
Port source: coordinator/lib/detect-hardware.sh (example-doctrine-repo)
...
_PROG = "detect-hardware"  # literal program-name prefix, matches the example-doctrine-repo oracle's echo prefix
