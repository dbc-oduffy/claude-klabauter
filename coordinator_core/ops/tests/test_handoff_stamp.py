...
def test_kind_omitted_is_rejected(tmp_path):
    ...
    example-doctrine-repo 2026-07-26/27 follow-up) — the op no longer accepts an
...
def test_kind_force_replace_without_kind_is_rejected(tmp_path):
    ...
    example-doctrine-repo 2026-07-26/27 follow-up) — kind is required unconditionally,
...
#
# Spec backlink: docs/plans/... (example-doctrine-repo cross-repo memo, 2026-07-26) — 13
...
#       (cross-field guard — this is the EXACT defect 10 of the 13 example-doctrine-repo
...
def test_repair_archived_deployment_state_continued_without_continued_into_rejected(tmp_path):
    ...
    example-doctrine-repo hand-edits produced (deployment_state: continued stamped with
