...
def test_downstream_consumer_contract_drop_and_merge_fields() -> None:
    ...
    2026-08-06 with example-doctrine-repo-em: their /distill C3 leg logs each dropped
...
def test_keep_verdict_weights_nugget_volume_via_keep_threshold() -> None:
    ...
    (answered to example-doctrine-repo-em 2026-08-06): a caller wanting singleton-floor
