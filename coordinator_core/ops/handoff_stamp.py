...
# shipped_in_kind discriminant (DR-096, example-doctrine-repo 2026-07-26 ruling) — the
...
#
# Added 2026-07-26 after a example-doctrine-repo cross-repo memo (13 archived handoffs
...
# Terminal deployment_states (E1, example-doctrine-repo 2026-07-26/27 follow-up memo).
...
# — observed in the live corpus (example-doctrine-repo handoff 2026-07-24_112615_c0bd4682.md).
...
def _resolve_continued_into(worktree: Path, value: str) -> bool:
    ...
    2026-07-26 after a example-doctrine-repo repair session wrote a *guessed* successor
    ...
    tests for concrete examples pulled from example-doctrine-repo's actual archive):
