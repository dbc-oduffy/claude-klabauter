...
Port of: workday-start-cross-repo-memo-outbox-surface.sh (example-doctrine-repo b5a4192c,
2026-07-20). Cases mirror the example-doctrine-repo bash test suite (test-outbox-stale-nudge.sh,
Example-doctrine-repo 894d4bc6, 2026-07-22) plus additional negative and edge cases exercised
