...
Port source: coordinator/tests/test_atlas_refresh_gate.py (example-doctrine-repo,
...
same fixtures/assertions, plus platform-edge cases the example-doctrine-repo oracle test never
...
def test_skip_when_not_inside_git_work_tree(tmp_path, monkeypatch, capsys):
    """Negative case not covered by the example-doctrine-repo oracle test: bare (non-git) cwd."""
