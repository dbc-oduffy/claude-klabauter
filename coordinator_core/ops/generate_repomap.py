...
repomap generator. Port of: generate-repomap.sh (example-doctrine-repo b5a4192c, 2026-07-20).
...
(example-doctrine-repo-resident) before invoking this. Full gating doctrine:
docs/wiki/repomap-rag-gating.md (example-doctrine-repo-resident).
...
Negative-spec:
    ...
    - Trust-checks the resolved plugin_root via the canonical
      ...
      module for the full anchor list (`.claude/` prefix, example-doctrine-repo clone,
