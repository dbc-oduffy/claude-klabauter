...
const PROFILE_DIR = '../Users/example-operator/X/claude-klabauter/coordinator_core/ops/dispatch_emit/tests/fixtures/queue-profiles';
...
for (const b of BATCHES) {
  for (const r of b.rows) {
    ...
    _rows[r] = { rowId: r, batchId: b.id, batchKey: b.batch_key, path: _path, node: null, declaredFiles: [_path], touchedFiles: [_path], removedFiles: [], createdFiles: [], evidence: '', verifyFeedback: '', fixNode: null, widened: false, verifyRetried: false, onFailUsed: false, done: false, sha: '' };
  }
}
