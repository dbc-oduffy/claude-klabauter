...
Homing (per example-doctrine-repo's dispatch brief for this module, mirroring
...
Spec backlink: docs/plans/2026-07-29-grouping-approval-contract.md (example-doctrine-repo)
"""
