...
fence pair embedded in `skills/workstream-start/SKILL.md` (example-doctrine-repo) that
...
Spec backlinks:
  ...
  - Fence example (read-only reference, not ported verbatim):
    coordinator/skills/workstream-start/SKILL.md § "Freshness nudge" (example-doctrine-repo,
