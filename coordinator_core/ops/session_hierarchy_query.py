...
Example-doctrine-repo ``query-session-hierarchy.sh`` polyglot trampoline.
...
invoked from a example-doctrine-repo checkout after derive started writing engine-side — this
...
CLI entrypoint: ``main(argv)`` is the direct-import target for the example-doctrine-repo
...
Port of: query-session-hierarchy.sh (example-doctrine-repo b5a4192c, 2026-07-20)
