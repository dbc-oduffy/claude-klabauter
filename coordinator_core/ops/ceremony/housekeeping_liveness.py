...
asserting "the tracker refreshes at /handoff" would drift silently the moment a example-doctrine-repo edit
...
last fired, computed entirely from claude-klabauter's own substrate with zero dependency on example-doctrine-repo's
