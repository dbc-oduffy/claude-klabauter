...
Port of: verify-orientation-cache-sync.sh (example-doctrine-repo b5a4192c, 2026-07-20)
Spec backlink: docs/plans/2026-07-16-bash-clean-slate-residual-migration.md
               docs/plans/2026-05-18-orientation-cache-authoring-discipline.md

Division of labor with the example-doctrine-repo trampoline (template-variant #1, direct
...
def main(argv: List[str]) -> int:
    ...
    Assumes the caller (the example-doctrine-repo trampoline) has already confirmed
