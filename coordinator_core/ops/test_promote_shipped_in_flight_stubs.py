...
Port of: promote-shipped-in-flight-stubs.sh (example-doctrine-repo b5a4192c, 2026-07-20), and its
own test harness promote-shipped-in-flight-stubs.test.sh (example-doctrine-repo 3a561713,
...
# example-doctrine-repo bash did `|| echo 0` (fail-open) rather than `|| continue` (fail-closed)
...
def test_ac14_all_zero_counters_stays_quiet(git_fixture, monkeypatch, capsys):
    ...
    to scan at all. This is the "zero candidates at all" case example-doctrine-repo's
