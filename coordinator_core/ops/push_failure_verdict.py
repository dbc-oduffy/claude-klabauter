...
Example-doctrine-repo's Stop-hook auto-push advisory (`coordinator/hooks/scripts/
...
Origin memos (read for full context, not reproduced here):
    cross-repo/inbox/2026-08-06-example-doctrine-repo-em-autopush-advisory-worktree-contention.md
    cross-repo/inbox/2026-08-06-example-doctrine-repo-em-autopush-advisory-yes-build-the-verdict-op.md
