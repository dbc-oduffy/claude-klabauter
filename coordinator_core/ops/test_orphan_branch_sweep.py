...
Golden oracle verified byte-parity against the example-doctrine-repo-side plugin-ecosystem test
...
Port of: orphan-branch-sweep.sh (example-doctrine-repo b5a4192c, 2026-07-20)
...
# using a stubbed `gh` on PATH exactly like the example-doctrine-repo-side parity harness.
# ---------------------------------------------------------------------------
