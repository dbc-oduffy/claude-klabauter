...
Port of: detect-project-runtime.sh (example-doctrine-repo b5a4192c, 2026-07-20, 125 lines)
Spec backlink: archive/specs/2026-05-06-detect-project-runtime.md (example-doctrine-repo)
