...
OP_MODULE_MAP: Dict[str, str] = {
    ...
    "hooks.guard_python_syntax_on_write":     "coordinator_core.hooks",
    "hooks.guard_posix_invocation_doctrine_write": "coordinator_core.hooks",
    "hooks.guard_test_tree_git_fixture_spawn": "coordinator_core.hooks",
    "hooks.guard_handoff_summary_cap_on_write": "coordinator_core.hooks",
    "hooks.guard_repo_setup_claude_home_refusal": "coordinator_core.hooks",
    "hooks.guard_review_integrator_sidecar_intake": "coordinator_core.hooks",
    ...
    "hooks.guard_host_subagent_bash_ban":     "coordinator_core.hooks",
    "hooks.guard_host_subagent_bash_spawn_shapes": "coordinator_core.hooks",
    "hooks.preuse_bash_dispatch":             "coordinator_core.hooks",
    "hooks.block_workflow_foreign_emission":  "coordinator_core.hooks",
    "hooks.block_workflow_unmodeled_agent":   "coordinator_core.hooks",
    "hooks.allow_emitted_workflow_fire":      "coordinator_core.hooks",
    "hooks.nudge_workflow_authoring_trampoline": "coordinator_core.hooks",
    "hooks.nudge_multiwave_workflow":         "coordinator_core.hooks",
    "hooks.block_dispatch_suite_invocation":  "coordinator_core.hooks",
    "hooks.strip_worktree_isolation":         "coordinator_core.hooks",
    "hooks.block_worktree_tool":              "coordinator_core.hooks",
    ...
    "hooks.sessionstart_ensure_http_forwarder": "coordinator_core.hooks",
    "hooks.guard_hook_generation_self_probe": "coordinator_core.hooks",
    "hooks.session_start_guard_plane_check":  "coordinator_core.hooks",
    "hooks.project_orientation":              "coordinator_core.hooks",
    "hooks.pickup_autofire":                  "coordinator_core.hooks",
    "hooks.mise_autofire":                    "coordinator_core.hooks",
    "hooks.handoff_segment_inject":           "coordinator_core.hooks",
    "hooks.group_em_autofire":                "coordinator_core.hooks",
    "hooks.nudge_initiative_goals_ladder":    "coordinator_core.hooks",
    "hooks.offer_exploration_tier_dispatch":  "coordinator_core.hooks",
    "hooks.observe_config_change":            "coordinator_core.hooks",
    "hooks.observe_post_compact":             "coordinator_core.hooks",
    "hooks.postuse_stop_family_dispatch":     "coordinator_core.hooks",
    "hooks.sessionend_auto_commit":           "coordinator_core.hooks",
    "hooks.subagent_zero_tool_use_detect":    "coordinator_core.hooks",
