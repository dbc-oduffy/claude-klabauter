...
memos — the claude-klabauter-native port of the example-doctrine-repo `cross-repo-memo` CLI's `list`
...
Spec backlink:
    ...
    Parity source: example-doctrine-repo coordinator/bin/cross-repo-memo `_cmd_list`
