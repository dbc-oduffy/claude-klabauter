...
Port of: normalize-env.sh (example-doctrine-repo ca30f76c, 2026-07-17), 1075 lines, bash 3.2-safe
...
probe layer previously bridged to example-doctrine-repo's scripts/lib/prereq_probe.sh via a
...
def _ne_default_prereq_probe_path() -> Optional[str]:
    """Resolution order: explicit env var set by the example-doctrine-repo-side trampoline
