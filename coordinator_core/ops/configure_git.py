...
_SETTINGS: tuple[GitSetting, ...] = (
    ...
    # scope="global" per example-doctrine-repo-em's ruling (Ask 1, ruled (a)) in
    # cross-repo/inbox/2026-08-07-example-doctrine-repo-em-configure-git-per-key-scope-ruled-a.md,
    ...
    # (scope="global") even when this writer runs per-repo — example-doctrine-repo's
