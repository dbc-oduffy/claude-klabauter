...
write DID land (SubagentStop is not pinned as the sole trigger; example-doctrine-repo's own spike found
...
Negative-spec:
    ...
    the whole session — that stays example-doctrine-repo-side per the cross-repo contract. This op only
...
Spec backlink: cross-repo/inbox/2026-07-25-example-doctrine-repo-em-zero-tool-use-detection-verdict-viable.md
