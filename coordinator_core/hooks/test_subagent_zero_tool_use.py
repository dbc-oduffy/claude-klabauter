...
DoE-claude contract memo); a present-but-unreadable transcript (a directory in the
...
# not only zero — cross-repo/inbox/2026-07-25-doe-claude-em-zero-tool-use-store-
