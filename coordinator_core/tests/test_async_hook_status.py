...
Python port of Port of: async-hook-status.sh (example-doctrine-repo c187f5b9, 2026-07-21)
(DOE-PORT R1, sourced-lib shape).

Mirrors Port of: async-hook-status.test.sh (example-doctrine-repo c187f5b9, 2026-07-21)'s
AC5 sub-properties:
