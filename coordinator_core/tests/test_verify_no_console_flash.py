...
the example-doctrine-repo-side bats/sh oracle tests.

Port of: verify-no-console-flash.sh (example-doctrine-repo 894d4bc6, 2026-07-22)
Test oracle: test-verify-no-console-flash.sh (example-doctrine-repo 894d4bc6, 2026-07-22)
"""
...
# ---------------------------------------------------------------------------
# Edge cases not in the example-doctrine-repo oracle suite but load-bearing for the port
# ---------------------------------------------------------------------------
