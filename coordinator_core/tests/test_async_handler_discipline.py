...
_ZERO_AWAIT_PRE_EXISTING_ALLOWLIST: frozenset[tuple[str, str]] = frozenset({
    ('coordinator_core/ops/artifact_emit.py', '_artifact_emit'),
    ('coordinator_core/ops/assert_doctrine_cross_reference_counts.py', '_handler'),
    ('coordinator_core/ops/bootstrap_repo.py', '_validate_target_root_op'),
    ('coordinator_core/ops/cartography_chunk_table.py', '_cartography_chunk_table'),
    ('coordinator_core/ops/cartography_churn.py', '_cartography_churn'),
    ('coordinator_core/ops/cartography_edges.py', '_cartography_edges'),
    ('coordinator_core/ops/cartography_edges.py', '_cartography_count_references'),
    ('coordinator_core/ops/cartography_file_index.py', '_cartography_file_index'),
    ('coordinator_core/ops/cartography_op_edges.py', '_cartography_op_edges'),
    ('coordinator_core/ops/cartography_stack.py', '_cartography_stack'),
    ('coordinator_core/ops/cartography_symbols.py', '_cartography_symbols'),
    ('coordinator_core/ops/cartography_tree.py', '_cartography_tree'),
    ('coordinator_core/ops/cascade_retract.py', '_handler'),
    ('coordinator_core/ops/ceremony/render_handoff_tracker.py', '_handler'),
    ('coordinator_core/ops/ceremony/session_instructions.py', '_handler'),
    ('coordinator_core/ops/ceremony/update_docs_scan.py', '_ceremony_update_docs_scan'),
    ('coordinator_core/ops/crossrepo_closure_status.py', '_handler'),
    ('coordinator_core/ops/deferral_detect_orphan_memo.py', '_handler'),
    ('coordinator_core/ops/deferral_detect_partial_strangle.py', '_handler'),
    ('coordinator_core/ops/detect_plugin_layout.py', '_handler'),
    ('coordinator_core/ops/detect_primary_languages.py', '_detect_primary_languages'),
    ('coordinator_core/ops/distill_curate_clusters.py', '_handler'),
    ('coordinator_core/ops/distill_curation_status.py', '_distill_curation_status'),
    ('coordinator_core/ops/distill_disposal_manifest.py', '_handler'),
    ('coordinator_core/ops/distill_scope.py', '_handler'),
    ('coordinator_core/ops/distill_stamp_disposal.py', '_handler'),
    ('coordinator_core/ops/distill_workflow_input.py', '_handler'),
    ('coordinator_core/ops/draft_plan_aging.py', '_plan_list_stale_executing'),
    ('coordinator_core/ops/draft_plan_aging.py', '_plan_list_orphaned'),
    ('coordinator_core/ops/emit/recorder.py', '_backlog_record'),
    ('coordinator_core/ops/engine_drift.py', '_engine_drift'),
    ('coordinator_core/ops/ensure_python3_exe_shim.py', '_detect_python3_appx_stub'),
    ('coordinator_core/ops/fleet/memo_blitz_buckets.py', '_memo_blitz_buckets'),
    ('coordinator_core/ops/fleet/memo_check_addressee.py', '_memo_check_addressee'),
    ('coordinator_core/ops/fleet/memo_compose.py', '_memo_compose'),
    ('coordinator_core/ops/fleet/memo_draft.py', '_memo_draft'),
    ('coordinator_core/ops/fleet/memo_list.py', '_memo_list'),
    ('coordinator_core/ops/fleet/memo_list_outbox.py', '_memo_list_outbox'),
    ('coordinator_core/ops/fleet/plan_handoffs.py', '_handoffs_for_plan'),
    ('coordinator_core/ops/goal_append.py', '_goal_append'),
    ('coordinator_core/ops/goal_close_day.py', '_goal_close_day'),
    ('coordinator_core/ops/goal_close_day.py', '_goal_close_day_apply'),
    ('coordinator_core/ops/goal_kr_status.py', '_goal_set_kr_status'),
    ('coordinator_core/ops/goals_match.py', '_handler'),
    ('coordinator_core/ops/handoff_children.py', '_handoff_blocked_by_dependents'),
    ('coordinator_core/ops/handoff_lineage_ancestry.py', '_handler'),
    ('coordinator_core/ops/handoff_match.py', '_handler'),
    ('coordinator_core/ops/handoff_repoint_origin.py', '_handler'),
    ('coordinator_core/ops/hibernate_machine.py', '_machine_hibernate'),
    ('coordinator_core/ops/init_anchor_injection_state.py', '_handler'),
    ('coordinator_core/ops/initiatives_serve.py', '_handler'),
    ('coordinator_core/ops/lessons_filter.py', '_lessons_filter_undated_universal'),
    ('coordinator_core/ops/lessons_filter.py', '_lessons_reject_orphan_strip_entries'),
    ('coordinator_core/ops/list_files_newer_than_marker.py', '_list_files_newer_than_marker'),
    ('coordinator_core/ops/memo_fate_backfill.py', '_handler'),
    ('coordinator_core/ops/memo_fate_partition.py', '_handler'),
    ('coordinator_core/ops/memo_triage.py', '_handler'),
    ('coordinator_core/ops/merge_quiet_activity_gate.py', '_handler'),
    ('coordinator_core/ops/parse_cli_args.py', '_handler_parse_flag'),
    ('coordinator_core/ops/parse_cli_args.py', '_handler_parse_date_flags'),
    ('coordinator_core/ops/percolate_check_inverse_drift.py', '_percolate_check_inverse_drift'),
    ('coordinator_core/ops/percolate_ci_smoke_check.py', '_percolate_run_ci_smoke_check'),
    ('coordinator_core/ops/percolate_identity_check.py', '_percolate_run_identity_check'),
    ('coordinator_core/ops/percolate_run.py', '_percolate_run'),
    ('coordinator_core/ops/percolate_validate.py', '_percolate_validate_store'),
    ('coordinator_core/ops/ping.py', '_ping'),
    ('coordinator_core/ops/plan_match.py', '_handler'),
    ('coordinator_core/ops/priority_drain.py', '_priority_drain'),
    ('coordinator_core/ops/priority_set.py', '_priority_set'),
    ('coordinator_core/ops/probe_fresh_repo_noop.py', '_probe_fresh_repo_noop'),
    ('coordinator_core/ops/queue_age_ping.py', '_handler'),
    ('coordinator_core/ops/queue_append.py', '_queue_append_handler'),
    ('coordinator_core/ops/queue_cluster.py', '_handler'),
    ('coordinator_core/ops/queue_promote.py', '_queue_promote_handler'),
    ('coordinator_core/ops/records_query.py', '_handler'),
    ('coordinator_core/ops/repo_bootstrap.py', '_clone_and_register_sibling_repo_op'),
    ('coordinator_core/ops/resolve_mcp_server_cli_path.py', '_handler'),
    ('coordinator_core/ops/resolve_swept_baton.py', '_resolve_swept_baton_in_archive'),
    ('coordinator_core/ops/roadmap_serve.py', '_handler'),
    ('coordinator_core/ops/scan_unresolved_ubt_records.py', '_scan_unresolved_ubt_handler'),
    ('coordinator_core/ops/schema_drift_gate.py', '_handler'),
    ('coordinator_core/ops/session/guard_settings_integrity.py', '_handler'),
    ('coordinator_core/ops/session/guard_settings_integrity.py', '_handler_kill_switch_detail'),
    ('coordinator_core/ops/session/scope_report.py', '_handler'),
    ('coordinator_core/ops/session_hierarchy_derive.py', '_handler'),
    ('coordinator_core/ops/strategic_emit.py', '_strategic_emit'),
    ('coordinator_core/ops/strategic_generate.py', '_strategic_generate'),
    ('coordinator_core/ops/testing_full_runner.py', '_testing_full_runner'),
    ('coordinator_core/ops/updatedocs_gates.py', '_updatedocs_gates'),
    ('coordinator_core/ops/workflow_scaffold.py', '_workflow_scaffold'),
    ('coordinator_core/ops/workflow_validate.py', '_workflow_validate'),
    ('coordinator_core/ops/write_surface_manifest.py', '_emit_write_surface_manifest'),
    ('coordinator_core/hooks/context_pressure_precompact.py', '_handler'),
    ('coordinator_core/hooks/nudge_foreground_agent_dispatch.py', '_handler'),
    ('coordinator_core/hooks/nudge_named_agent_report_delivery.py', '_handler'),
})
