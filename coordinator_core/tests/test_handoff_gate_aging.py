...
Port of: handoff-gate-aging.sh (example-doctrine-repo 67202df6, 2026-07-16) — the bash
...
def test_classify_real_corpus_signed_commit_never_evidence_resolved():
    ...
    the schema is example-doctrine-repo-gated). Against today's real corpus this must resolve
