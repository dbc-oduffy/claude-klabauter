...
dispatcher routed the crash to `_crash_deny`, and a example-doctrine-repo session had
its `grep` invocations denied by a defect in an uncommitted file it did not
own (`cross-repo/inbox/2026-07-30-example-doctrine-repo-em-guard-grep-via-bash-
nameerror.md`).
