...
coordinator_core/install/sandbox_check.py exercises the example-doctrine-repo/coordinator-
claude install chain (gen-settings-hooks, .doe-root, claude-doe-shim, etc.)
-- that harness validates a DIFFERENT install surface (the example-doctrine-repo-side plugin
