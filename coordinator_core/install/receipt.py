...
precedent example-doctrine-repo's `commands/uninstall.md:141` names ("install records what it
...
confirmed absent when this was relayed to example-doctrine-repo, see
