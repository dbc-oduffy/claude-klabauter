...
Port source: coordinator/scripts/lib/manifest_reader.sh [example-doctrine-repo repo]
...
Python at all:
  ...
  2. resolve_manifest_path()'s bash original falls back to a location
     ...
     because manifest_reader.sh lives inside the example-doctrine-repo coordinator/
