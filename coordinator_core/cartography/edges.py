...
IN-BAND COMPLETENESS MARKER (the Staff Engineer Finding 4, 2026-07-12): every payload
...
docs/plans/2026-08-06-claude-klabauter-ize-the-survey-census.md § chunk C15. Boundary-
marker join: docs/plans/2026-08-06-claude-klabauter-ize-the-survey-census.md § chunk
...
def build_edges(
    ...
    (AC7, the Staff Engineer Finding 4) — always present, regardless of input, so a
