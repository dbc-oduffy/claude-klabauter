...
Replays the NORMATIVE conformance fixture (DoE-side
...
@pytest.mark.skipif(_FIXTURE_PATH is None, reason="DoE sibling conformance fixture not discoverable on disk")
