...
Why this exists: ``DR-EXAMPLE-GAME-REPO-006`` was allocated on 2026-06-15 and
...
miss precisely the way DR-EXAMPLE-GAME-REPO-006's original author missed it. This test
...
# next door — precisely DR-EXAMPLE-GAME-REPO-006's shape: a check everyone believes
...
def test_doc_scaffold_write_site_reverifies_uniqueness_before_writing():
    ...
    docstring promise, armed against a repeat of DR-EXAMPLE-GAME-REPO-006 (allocated
    ...
    assert has_marker, (
        ...
        "produced DR-EXAMPLE-GAME-REPO-006 (allocated 2026-06-15, collided eight "
