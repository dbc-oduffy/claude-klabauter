...
Dual-homed EDGE_KIND_META SSOT:
  ...
  origin_handoff provenance edge (ratified spinoff-provenance-ancestry contract):
    ...
    Ratification memo: cross-repo/inbox/2026-07-07-spinoff-provenance-makima-ratified.md
...
Cycle-vs-convergence semantics (verbatim from JS, walk-handoff-dag.js:9-31):
  ...
  This preserves diamond summation (Zolí F1) AND surfaces true authoring cycles (Zolí F6).
...
# live child (five call sites)"; project-opticon-em, 2026-08-05,
# cross-repo/inbox/2026-08-05-project-opticon-em-wsc-leg-b-counts-spinoffs-
# as-live-children.md.
# ---------------------------------------------------------------------------
...
# Measured on the 2026-08-18 corpora (DoE-claude M=676/N=231, makima M=567/N=147):
...
#     DoE-claude and 39 -> 38 (-1) on project-makima's own corpus. CORRECTION
#     (measured against project-makima's own corpus only — the DoE-claude
...
# `50e2847 reclaim(archive): DoE pre-July archive history from makima`, which
# squash-reclaimed inert pre-July archive records that had been stranded in
# makima by the 2026-07-03 relocation. That reclaim brought in each SUCCESSOR
# handoff (the record listed as a key below) but NOT its own predecessor,
# which lived and died entirely inside makima's original (pre-split) repo
