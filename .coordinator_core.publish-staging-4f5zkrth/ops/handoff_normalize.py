...
Negative-spec (hard-won):
  ...
  - Does NOT walk subdirectories of state/handoffs/ — flat glob only (*.md), matching
    the JS walkHandoffsDir flat constraint (holodeck legacy archive subdir excluded).
"""
...
def _normalize_one_text(
    ...
    (producer-axis-makima-engine-half) — same caller-supplied-parameter
    ...
    # producer-axis-makima-engine-half: {typed_command, op_identity} resolved
