...
Registry keys use underscores (`project_opticon`); prose codenames commonly
use hyphens (`project-opticon`) — this guard derives and greps BOTH forms per
...
"repos.project_opticon repos.project_rag"), those keys are used instead of
