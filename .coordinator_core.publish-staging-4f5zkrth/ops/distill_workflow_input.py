...
the consumer (DoE's distill-harvest.workflow.js) can pin against, so neither
side's next edit silently reopens the hand-adapter.

Integrity counts (2026-08-06 project-rag-em incident —
cross-repo/inbox/2026-08-06-project-rag-em-distill-workflow-inputfile-silent-
...
that assertion is DoE's distill-harvest.workflow.js's own change to make
...
Spec backlink: pln-makima-driven-ceremony-redesig-c7fe9a § C10
Fold-in ask: cross-repo/inbox/2026-08-06-project-rag-em-distill-workflow-
