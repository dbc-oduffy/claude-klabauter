...
This op does NOT use the opticon two-phase envelope (contract §2.1/DEC-1) — it
...
Negative-spec:
  ...
  - Does NOT implement the opticon two-phase mode/candidate_ids envelope — this
  ...
  - Does NOT harden _MARKER_RE against a flush-left occurrence of the marker
    ...
    an oversight: it matches DoE's own reference implementation
...
async def _handler(params: dict, repo_root: Optional[Path] = None) -> dict:
    ...
    Custom result shape (NOT the opticon two-phase mode/candidate_ids envelope,
    ...
    # intentional per DEC-1 (this op does not use the opticon mode/candidate_ids
