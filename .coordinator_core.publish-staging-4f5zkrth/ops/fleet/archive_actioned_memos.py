...
(single cold-start, no opticon wire-contract overhead).

Spec backlinks:
  - Plan (C3): docs/plans/2026-07-06-strang-11-b8-session-init-op-absorption.md § C3
  - Wire contract (FROZEN): coordinator_core/contract/opticon-invoke-producer-contract.md §2.2
  - DR-211: docs/decisions/DR-211-fleet-op-substrate-write-boundary.md (D1-D4)
  - Port of: coordinator-session.sh (DoE e34f2484, 2026-07-22) cs_sweep_actioned_memos
...
#: Spec backlink: cross-repo report to project-opticon, 2026-07-26.
