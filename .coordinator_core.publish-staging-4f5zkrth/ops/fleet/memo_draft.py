...
DR-210 Option-A boundary move (makima owns receiver-resolution + compose/
...
Spec backlink:
    ...
    DR-210: docs/decisions/DR-210-makima-native-tooling-ownership-strangler.md
    ...
    Parity source: DoE coordinator/bin/cross-repo-memo.py _cmd_draft /
        ...
        cross-repo/inbox/2026-07-17-project-rag-em-cross-repo-memo-cli-footguns.md
...
def _classify_receiver_for_draft(to: str, dry_run: bool):
    ...
    Returns one of three shapes:
      ...
      - `str` — 2026-07-24 papercut fix (sibling-EM report): when `to` does
        ...
        'makima-em' -> 'project-makima-em'), that candidate is auto-accepted
