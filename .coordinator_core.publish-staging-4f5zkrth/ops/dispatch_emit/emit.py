...
phase probe (docs/research/spike-verdicts/2026-08-18-makima-fires-an-
...
makima does not own; runtime-parsing ``routing.md`` prose would add a
...
# mapping lives here (makima-owned) rather than a sizing->reviewer table
...
#: inside an agent result rather than at a phase boundary (project-rag-em
...
def _commit_halt_gate(commit_var: str, phase_title: str) -> str:
    ...
    files left (project-rag-em, 2026-08-20; recovered that way by luck, and
    said so).
