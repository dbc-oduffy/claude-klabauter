...
works for the makima plane. The bash oracle exposes a single public shell function,
...
(`probe_cwd_project_rag_relevance`); this module was the largest-blast-radius
