...
history/lessons that cite "Rule N"):
  ...
  Rule 5 — H3 status-closure block (all allowlisted files): delete any H3
           ...
           holodeck-bug-backlog pattern: "### [FIXED 2026-05-16] BS-... <30
  ...
  Rule 6 — Strikethrough-closure line strip (all allowlisted files): drop any
           ...
           (FIXED|RESOLVED|CLOSED|DONE|COMPLETED). Catches the DroneSim
...
Spec backlink: docs/plans/2026-05-07-prune-resolved-state-bloat.md § S5
               ...
               here — this module is the makima-owned engine half)
...
GENERATES = []  # operates only on caller-supplied paths basenamed improvement-queue.md/bug-backlog.md, neither currently tracked in makima's own tree
