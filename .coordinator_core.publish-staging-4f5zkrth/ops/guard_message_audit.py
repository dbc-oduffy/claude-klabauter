...
to us as suspected prompt injection (project-rag and market-intelligence,
2026-08-11; project-opticon, 2026-08-13). Each report was actioned by editing the
...
Reports it answers: cross-repo/inbox/2026-08-13-project-opticon-em-guard-advisories-read-as-injection-to-subagents.md,
