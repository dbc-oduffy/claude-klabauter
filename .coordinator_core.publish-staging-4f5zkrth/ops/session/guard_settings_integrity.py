...
GENERATES = []  # writes settings.json/.settings-last-good.json/.settings-clobbered.bak/known-good backups under the operator's ~/.claude config dir, never a tracked path in makima's own tree
...
# installed (the 2026-07-28 holodeck/holodeck-control/game-dev incident:
...
# repointer needs to touch. It currently names a makima-local JSON file
...
def _load_plugin_gating_contract() -> dict:
    ...
    ones the contract names. `project-rag@project-rag` (currently `true`)
    is a known open PM question (state/improvement-queue/2026-08-14-
    project-rag-s-11-3kb-agent-skill-payload-9795e0c6bfd3.yaml) and is
...
# (2026-07-14, per DoE-claude archive/daily-summaries/2026-07-14-striker.md
# and state/2026-07-28-striker-install-dogfood-friction-log.md) was "delete
# once the naked-Python hook migration lands". That migration is COMPLETE
# (37/37 hook scripts are Python, verified 2026-07-28 on the striker
