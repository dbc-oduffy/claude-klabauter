...
def _default_groups(
    ...
    module's dispatching memo (project-opticon-em, 2026-08-17) for the
...
def _render_report(report: AutoCommitReport, worktree_root: Optional[str] = None) -> str:
    ...
    A THIRD property, from the project-opticon-em memo of 2026-08-05: every
    ...
    for g in groups:
        ...
        if g["committed"]:
            ...
            # to it (project-opticon-em memo, 2026-08-05).
            lines.append(
