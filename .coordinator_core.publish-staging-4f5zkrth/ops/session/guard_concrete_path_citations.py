...
hardcoded Windows path (`X:\\claude-unreal-holodeck`) sitting in an
...
trailing `...` (`C:\Users\oduffy\project\...`) has a genuine concrete
segment (`oduffy`) ahead of the ellipsis and must NOT be swallowed by the
