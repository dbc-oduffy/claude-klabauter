...
def test_drive_letter_flagged() -> None:
    hits = detect_in_text(r"the repo lives at X:\claude-unreal-holodeck on that box")  # abs-path-ok: synthetic test fixture
...
def test_posix_home_real_username_flagged() -> None:
    hits = detect_in_text("/Users/realperson/X/project-makima")  # abs-path-ok: synthetic test fixture
...
def test_posix_home_user_segment_is_concrete_not_a_placeholder() -> None:
    ...
    exempted it."""
    hits = detect_in_text("/Users/user/X/project-makima")  # abs-path-ok: synthetic test fixture
    assert any(f.rule == "posix-home" for f in hits)
...
def test_trailing_ellipsis_after_a_real_segment_still_flagged() -> None:
    ...
    hits = detect_in_text(r"the repo lives at C:\Users\oduffy\project\...")  # abs-path-ok: synthetic test fixture
    assert any(f.rule == "drive-letter" for f in hits)
...
def test_marker_with_reason_exempts_line() -> None:
    line = r"X:\claude-unreal-holodeck  # abs-path-ok: quoting the 2026-07-28 incident"  # abs-path-ok: synthetic test fixture
...
def test_bare_marker_without_reason_does_not_exempt() -> None:
    ...
    line = "X:\\claude-unreal-holodeck  # " + trailing_colon_no_reason  # abs-path-ok: synthetic test fixture, assembled at runtime
    hits = detect_in_text(line)
    assert any(f.rule == "drive-letter" for f in hits)
...
def test_review_trail_hand_authored_note_is_not_exempt() -> None:
    ...
    text = "the repo lives at X:\\claude-unreal-holodeck\n"  # abs-path-ok: synthetic test fixture
    hits = detect_in_text(
...
def test_capture_data_jsonl_under_audits_data_is_exempt() -> None:
    ...
    text = '{"cwd": "/Users/realperson/X/project-makima"}\n'  # abs-path-ok: synthetic test fixture
...
def test_capture_data_hand_authored_md_under_recovery_is_not_exempt() -> None:
    ...
    text = "the repo lives at /Users/realperson/X/project-makima\n"  # abs-path-ok: synthetic test fixture
...
def test_jsonl_outside_prefix_is_exempt_on_format_alone() -> None:
    ...
    text = '{"delivery_commit_reason": "fatal: /Users/realperson/X/project-makima/x"}\n'  # abs-path-ok: synthetic test fixture
...
def test_yaml_scalar_exempt_via_content_model_not_extension() -> None:
    ...
    text = "decision_note: failed at /Users/realperson/X/project-makima/x\n"  # abs-path-ok: synthetic test fixture
...
def test_yaml_plain_scalar_still_fires() -> None:
    ...
    text = "note: the failure was at /Users/realperson/X/project-makima/x\n"  # abs-path-ok: synthetic test fixture
    hits = detect_in_text(text, filename="entry.yaml")
    assert any(f.rule == "posix-home" for f in hits)
...
def test_yaml_path_shaped_mapping_key_still_fires() -> None:
    ...
    value's own style."""
    text = "/Users/realperson/X/project-makima: value\n"  # abs-path-ok: synthetic test fixture
    hits = detect_in_text(text, filename="entry.yaml")
    assert any(f.rule == "posix-home" for f in hits)
...
def test_yaml_folded_block_scalar_exempt() -> None:
    text = (
        "note: >-\n"
        "  the failure was at /Users/realperson/X/project-makima/x\n"  # abs-path-ok: synthetic test fixture
    )
...
def test_yaml_comment_line_still_fires() -> None:
    ...
    text = "# see /Users/realperson/X/project-makima/x for the shape\n"  # abs-path-ok: synthetic test fixture
    hits = detect_in_text(text, filename="entry.yaml")
    assert any(f.rule == "posix-home" for f in hits)
...
def test_md_frontmatter_value_still_fires() -> None:
    ...
    text = (
        "---\n"
        "note: the failure was at /Users/realperson/X/project-makima/x\n"  # abs-path-ok: synthetic test fixture
        "---\n"
...
def test_md_prose_after_frontmatter_still_fires() -> None:
    text = (
        ...
        "title: fine\n"
        "---\n"
        "the repo lives at /Users/realperson/X/project-makima\n"  # abs-path-ok: synthetic test fixture
    )
    hits = detect_in_text(text, filename="doc.md")
    assert any(f.rule == "posix-home" for f in hits)
...
def test_md_fenced_backtick_block_exempt() -> None:
    text = (
        "prose before\n"
        "```\n"
        "cd /Users/realperson/X/project-makima\n"  # abs-path-ok: synthetic test fixture
        "```\n"
        "prose after\n"
    )
    hits = detect_in_text(text, filename="doc.md")
...
def test_py_string_literal_path_still_fires() -> None:
    ...
    text = "path = '/Users/realperson/X/project-makima'\n"  # abs-path-ok: synthetic test fixture
    hits = detect_in_text(text, filename="mod.py")
    assert any(f.rule == "posix-home" for f in hits)
...
def test_md_four_space_lazy_list_continuation_still_fires() -> None:
    ...
    text = (
        ...
        "    continues at /Users/realperson/X/project-makima as a lazy line\n"  # abs-path-ok: synthetic test fixture
    )
    hits = detect_in_text(text, filename="doc.md")
    assert any(f.rule == "posix-home" for f in hits)
...
def test_md_lazy_list_continuation_after_blank_line_still_fires() -> None:
    ...
    text = (
        "- item one starts here\n"
        "\n"
        "    /Users/realperson/X/project-makima is item text, not code\n"  # abs-path-ok: synthetic test fixture
    )
    hits = detect_in_text(text, filename="doc.md")
    assert any(f.rule == "posix-home" for f in hits)
...
def test_md_genuine_indented_code_inside_list_item_is_exempt() -> None:
    ...
    text = (
        "- item one starts here\n"
        "\n"
        "      /Users/realperson/X/project-makima\n"  # abs-path-ok: synthetic test fixture
    )
...
def test_md_deeply_nested_list_continuation_still_fires() -> None:
    ...
    text = (
        ...
        "      - d\n"
        "\n"
        "        /Users/realperson/X/project-makima is item text\n"  # abs-path-ok: synthetic test fixture
    )
    hits = detect_in_text(text, filename="doc.md")
    assert any(f.rule == "posix-home" for f in hits)
...
def test_md_inline_code_span_still_fires() -> None:
    ...
    text = "see `/Users/realperson/X/project-makima` for the shape\n"  # abs-path-ok: synthetic test fixture
    hits = detect_in_text(text, filename="doc.md")
    assert any(f.rule == "posix-home" for f in hits)
