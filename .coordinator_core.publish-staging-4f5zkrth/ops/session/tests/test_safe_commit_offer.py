...
class TestExactModeOnly:
    ...
    def test_journal_form_agent_touched_yields_paths_and_honours_release(self, tmp_path):
        """End-to-end pin for the 2026-08-04 market-intelligence-em report:
...
# (project-opticon-em memo, 2026-08-05), a 1-file commit was reported as
...
# ---------------------------------------------------------------------------
# (g) --invoker framing (project-opticon-em memo, 2026-08-17): a deliberate
