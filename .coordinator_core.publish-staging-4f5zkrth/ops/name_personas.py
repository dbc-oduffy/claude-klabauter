...
guarantee of) a `project-makima` sibling clone, `coordinator_core`, or a
`.makima-root` machine-local pointer. A `from coordinator_core.ops.name_personas
...
# repo root; neither exists as a tracked path in makima's own tree (no
