...
(2026-07-21, sh_argv-class retirement, docs/plans/2026-07-21-makima-pure-python-shop-
retire-all-bash.md C18): the DoE-side `.sh` this used to shell out to is itself only a
polyglot trampoline back onto this exact same makima module (see that file's own
...
real separate binary, not a makima module.
