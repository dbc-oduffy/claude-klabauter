...
regression-net-ported from prune-resolved-queue-entries.test.sh (DoE 3a561713,
...
def test_rule6_dronesim_shape_strikethrough_row_dropped(tmp_path):
    rc, out = _run(
        tmp_path,
        "bug-backlog.md",
...
def test_rule7_geneva_mvp_row_dropped(tmp_path):
    rc, out = _run(
        tmp_path,
        "bug-backlog.md",
