...
Run: cd project-makima && python3 -m pytest coordinator_core/ops/test_verify_coverage.py -q
"""
    ...
    root = _scaffold(
        ...
        {"coordinator": {"skills": ["plan"]}},
        {
            "coordinator/skills/plan/SKILL.md": (
                "# plan\n\nDispatch `holodeck-control:ue-asset-author`. "
...
def test_subagent_builtin_harness_type_resolves(tmp_path):
    ...
    # project-rag-em-verify-coverage-false-positive-orphans.md item 2.
    root = _scaffold(
        tmp_path,
        {"coordinator": {"skills": ["plan"]}},
        {
