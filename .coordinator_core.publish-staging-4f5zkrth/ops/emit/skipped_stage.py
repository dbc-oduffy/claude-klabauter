...
directly comparable to ``git ls-files`` output" (a rag/opticon JOIN KEY), resurrected the
...
# to memo for the life of the process because makima is spawn-per-call (DR-215) — the file is
