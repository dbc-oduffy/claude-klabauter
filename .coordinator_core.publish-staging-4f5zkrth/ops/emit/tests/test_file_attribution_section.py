...
def test_relativize_posix_out_of_repo():
    result = _relativize_or_exclude("/Users/x/DoE-claude/sub/file.py", PurePosixPath("/Users/x/claude-klabauter"))
...
def test_relativize_windows_shaped_out_of_repo():
    result = _relativize_or_exclude(
        r"C:\Users\x\DoE-claude\sub\file.py", Path(r"C:\Users\x\claude-klabauter")
    )
    assert result is None
