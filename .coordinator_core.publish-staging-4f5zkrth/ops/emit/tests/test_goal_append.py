...
def _make_git_repo(tmp_path: Path) -> Path:
    ...
    _git("init", "-b", "main")
    _git("config", "user.email", "goal-append-test@makima.test")
...
# ---------------------------------------------------------------------------
# _is_absolute_crp: cross-platform absoluteness test (Patrik review, Finding 0)
#
...
# ---------------------------------------------------------------------------
# _normalize_coordinator_root_path: symlink asymmetry (Patrik review, Finding 3)
#
...
# ---------------------------------------------------------------------------
# _goal_append(): handler-level out-of-repo raise (Patrik review, Finding 4)
#
