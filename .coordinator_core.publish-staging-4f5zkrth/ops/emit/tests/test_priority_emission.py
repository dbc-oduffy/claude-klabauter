...
def test_contract_version_carries_the_priority_ledger_bump() -> None:
    ...
    Pinned as a floor rather than an equality: project-opticon's checkSchemaVersion
    ...
    assert major == 3, f"major bump breaks opticon's ingest either direction: {CONTRACT_VERSION}"
