...
landed commit close this work item" fact opticon's ``recs-05``/B4 code-complete auto-assert
needs (source memo: 2026-07-17-project-opticon-em-wsc-commit-closure-emit.md).
...
successor in this tree. The current reader of this fact is project-opticon's auto-assert
