...
``cross-repo/archive/2026-07-21-project-makima-em-lessons-producer-absolute-provenance-
...
below, belt-and-suspenders with that source fix — makima's own real emissions stay
