...
Spec backlink: cross-repo/archive/2026-07-14-project-makima-em-wsc-close-origin-stub-join-and-session-shape-pickup-immutability.md
Also mirrors: coordinator-handoff-archive.sh (DoE c47b0268, 2026-07-19) ``--stamp-only`` path
DR:            DR-059 (break-class script-surface bugs route to makima migration,
                docs/decisions/2026-07-14-break-class-script-surface-bugs-route-to-makima-migration.md)
M1 spec backlink (in_flight liveness-gated admission + legible skip):
                cross-repo/inbox/2026-08-01-project-opticon-em-close-origin-stub-skips-in-flight.md
