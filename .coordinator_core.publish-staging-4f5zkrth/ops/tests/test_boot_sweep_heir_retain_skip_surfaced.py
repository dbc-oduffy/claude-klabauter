...
plugin-dir-les-2ee0e6522f92.yaml; cross-repo/inbox/2026-08-14-project-rag-em-
...
def heir_repo(tmp_path) -> HeirRetainRepo:
    ...
    _git("init", "-b", "main")
    _git("config", "user.email", "heir-retain-test@makima.test")
...
def test_continued_predecessor_reports_cascade_not_h4(heir_repo):
    ...
    Spec backlink: cross-repo/archive/2026-08-18-project-rag-em-consumed-
