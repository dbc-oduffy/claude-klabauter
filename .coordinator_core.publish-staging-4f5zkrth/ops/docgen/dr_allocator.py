...
verbatim by sibling repos — project-makima maintains a duplicate Python port
...
SSOT / vendoring: this module is tracked in project-makima only, in two
...
repo outside project-makima vendors a further copy of its own, that is
...
vendoring consumers, including project-makima's test suite, call these
...
def _frontmatter_dr_entries(
    ...
    Covers repos (e.g. project-opticon) where decision records are
...
def allocate_dr_number(
    ...
    Spec backlink: cross-repo/inbox/2026-07-20-holodeck-em-dr-number-allocator-collision.md
    Spec backlink: cross-repo/inbox/2026-08-01-project-opticon-em-dr-allocator-frontmatter-id-blindness.md
    """
