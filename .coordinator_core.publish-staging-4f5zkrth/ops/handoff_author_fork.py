...
``cross-repo/inbox/2026-07-07-spinoff-provenance-makima-ratified.md``).  No key swap
...
# (DoE C6 ratification memo: cross-repo/inbox/2026-07-07-spinoff-provenance-makima-ratified.md).
...
#
#   origin_goal_id     → ARRAY   (string[] | null) — multi-goal forks are real (opticon-flagged)
...
async def _handler(
    ...
    def _mutate(old_text: str) -> str:
        ...
        minted_by = operating_person.get("github")
        human_assignee = operating_person.get("contributor_slug")
        # producer-axis-makima-engine-half: op_identity resolved HERE, at this
