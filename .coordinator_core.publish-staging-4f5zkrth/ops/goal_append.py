...
cross-repo/archive/2026-07-13-claude-central-em-close-weekly-goal-loop-makima-emit-engine.md
and archive/specs/2026-07/2026-07-13-makima-emit-goal-wire-2130-projection.md):
...
_PHANTOM_REPO_FK_MEMO = (
    "cross-repo/inbox/2026-07-21-project-rag-em-goals-repo-fk-coordinator-root-split-latent.md"
)
...
def _normalize_coordinator_root_path(crp: Optional[str], repo_root: Path) -> str:
    ...
    this function exists to prevent (see Patrik review, Finding 1). Absolute inputs
    ...
    Spec backlink: cross-repo/inbox/2026-07-21-project-rag-em-goals-repo-fk-coordinator-root-split-latent.md
    """
    crp = (crp or ".").strip() or "."
