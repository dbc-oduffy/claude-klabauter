...
This is opticon's single-initiative live-render surface (makima serves live
...
shipped_sha precision (F1 — Patrik review):
...
Negative-spec:
  ...
  - Does NOT serve state/initiatives/ or the returned DAG as a fleet-wide/cross-initiative
    query surface — state/ IS makima's own disk-truth custody for its initiatives (per
