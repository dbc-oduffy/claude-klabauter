...
the batch session.boot_sweep to notice. This is makima's engine realization of
the "fire archival off the terminal-transition event, not a 24h/boot batch"
directive (cross-repo memo 2026-07-12-project-rag-em-handoff-archival-*), reconciled
...
Spec backlink: cross-repo/archive/2026-07-12-project-rag-em-handoff-archival-mtime-veto-and-marking-gap.md
...
# for the self-selecting, non-opticon-round-trip path — parity with session.boot_sweep).
