...
def _derive_trailers(
    ...
    chance to observe it -- reproducing the project-makima 506748a0
...
async def _run_precommit_tail(
    ...
    *,
    ...
    `partition_mandatory` (D, cross-repo/inbox/2026-08-15-project-rag-em-wsc-
...
async def _handler(params: dict, repo_root: Optional[Path] = None) -> dict:
    ...
    # deciding the minimal residue, per the plan's finding 17 (patrik): slimming
    ...
    #      Order table -- makima's re-drive occasion must land first).
    ...
    with _deferred_publisher_backstop(worktree_root, push_mode):
        if not resumed:
            ...
            if (b_adjudication_present or partition_mandatory) and not tail_ops.review_trail_metadata_complete(
                ...
                # D (cross-repo/inbox/2026-08-15-project-rag-em-wsc-review-trail-
                ...
                if partition_mandatory and not b_adjudication_present:
                    breach = (
                        # Review: staff-eng (Patrik) -- gates.review_scale.chain_slices is a key
    ...
    if committed_sha is not None:
        ...
        # Labelled-skip fix (cross-repo/inbox/2026-08-04-project-rag-em-wsc-
    ...
    tail_results["consumed_handoff_stamp"] = {
        ...
        "skipped": [
            ...
            *([f"consumed_handoff_stamp:{_commit_gap_reason(commit_failed, sha_unverified)}"]
            ...
            # -> cross-repo/inbox/2026-08-14-project-rag-em-wsc-tail-consumed
    ...
    # inbox/2026-08-04-project-rag-em-wsc-tail-abort-loses-baton-terminal-
    ...
    #     section -- a makima-side shed chunk must not assume a sibling chunk
