...
Negative-spec (hard-won):
  ...
  - Does NOT acquire a ceremony-wide lock itself, and its caller does not
    ...
    26 of 26 active days (2026-07-03..28), and makima 143c70a3 falsified the
...
async def _live_children_guard(
    ...
    try:
        ...
        # the close, still retains on that same spinoff (project-opticon-em,
        # 2026-08-05, cross-repo/inbox/2026-08-05-project-opticon-em-wsc-leg-
...
async def post_commit_stamp_and_ship(
    ...
    *,
    ...
    return StampOutcome(
        ...
        follow_up_committed_shas=follow_up_shas,
