...
Negative-spec:
    ...
    - ``write_review_trail`` is NOT shed by C6, and MUST NOT be shed as a follow-on "cleanup"
      ...
      see docs/plans/2026-07-23-wsc-tail-slim-down.md § C6 (zoli, finding 9) for the full
...
def fire_tracker_and_roadmap_detached(
    ...
    ASYNC-IS-NOT-A-SUBSTITUTE-FOR-CHEAP (patrik finding 19, module docstring honesty
...
async def write_review_trail(
    ...
    *,
    ...
    ``partition_mandatory`` (D, cross-repo/inbox/2026-08-15-project-rag-em-wsc-review-trail-
