...
Negative-spec (hard-won):
  ...
  - `explicit_stage()` never re-stages (bare `git add`) a path whose staged
    ...
    ever gets a chance to observe and preserve it (project-makima 506748a0
...
def explicit_stage(
    ...
    with worktree content -- the project-makima 506748a0 incident shape --
...
def commit(
    ...
    *,
    ...
    docstring for the two incidents (project-makima 506748a0, DoE-claude
    ...
    project-makima 506748a0 incident shape, through the function built to
