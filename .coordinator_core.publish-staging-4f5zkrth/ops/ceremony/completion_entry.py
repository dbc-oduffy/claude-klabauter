...
Behavior reference (read for behavior, not structure, per the plan's Anti-scope):
    ...
    project-makima coordinator_core/ops/ceremony/wsc_commit.py:944 (_tail_scaffold_completion_entry)
    project-makima coordinator_core/ops/ceremony/wsc_commit.py:1372 (_fill_completion_entry_residues)
"""
