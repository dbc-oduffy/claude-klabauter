...
10): makima does not own doctrine (project CLAUDE.md § Project Overview), and a registry
...
last fired, computed entirely from makima's own substrate with zero dependency on DoE's
