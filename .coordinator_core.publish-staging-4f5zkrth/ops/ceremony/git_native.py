...
def _empty_private_index_refusal(
    ...
    *,
    ...
    `pickup-assemble apply` on the box, which is where project-makima-7a
...
def status_porcelain(
    ...
    Measured on project-makima at ~40 dirty paths: 1071ms unscoped floor
...
#     deliberately-staged partial-hunk content (project-makima 506748a0).
...
def commit_scoped(
    ...
    *,
    ...
    # object unread. Reported by project-rag-em (cross-repo/inbox/2026-08-20-
    # project-rag-em-wave-commit-deliverable-id-is-per-session.md): a wave
    # commit agent wrote the BRANCH NAME `work/striker/2026-08-16to18` into
    ...
    # content exactly like the project-makima 506748a0 incident this
