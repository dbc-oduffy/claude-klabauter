...
Purpose: makima's generation-stamp mechanism for the DoE-landed ``handoff_phase``
...
``docs/plans/2026-07-17-makima-handoff-phase-execution-emit-leg.md``). Per the
PM's ruling ("makima owns the marking, the skill just carries the invocation" —
DR-210 § Decision 1), this op is makima's authoritative write path for the
...
Spec backlink: pln-makima-emit-leg-handoff-phase--e1ccf4 § C4/D1
