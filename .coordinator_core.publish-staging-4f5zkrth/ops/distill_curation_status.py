...
artifact (DEC-1: opticon/rag/siblings MAY consume it; makima never depends on their
consumption).
...
Spec backlink: pln-makima-driven-ceremony-redesig-c7fe9a § C11 (DEC-1)
...
(2026-07-23 Patrik post-execution review § 3; see `_last_distill_run`)."""
...
def _run_id_to_utc(run_id: str) -> Optional[_dt.datetime]:
    ...
    failure the DEC-1 self-reference fix existed to close (Patrik post-execution
