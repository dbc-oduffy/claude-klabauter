...
class TestContainmentGate:
    ...
    def test_sibling_git_repo_cross_repo_is_accepted(self, tmp_path):
        ...
        Guards against a false-reject that only allows the 'main' makima repo — the
...
"""
    ...
    # -- Live repro (AC1) --------------------------------------------------
    #
    # Reproduces the real 2026-07-28-project-opticon-em-... memo's shape
...
kind: "ask"
in_reply_to: "2026-07-28-project-makima-em-sat-01-store-home-answer.md"
---
"""
...
# no-escape-hatch gap: cross-repo/inbox/2026-08-12-project-rag-em-git-
