...
notion of a "transport" failure itself (no subprocess, no makima-internal call).
...
"the install step's own business logic failed" (1) apart from "the makima engine
link is broken" (2).
"""
