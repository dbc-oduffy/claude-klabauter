...
lived inside coordinator/bin/ itself. Ported into the makima engine tree, that anchor is
...
def _count_universals(extract_script: str, lessons_path: str, cutoff: str) -> int:
    ...
    avoiding a direct DoE→makima Python import edge). Returns 0 on any failure, matching
