...
`cross-repo/inbox/2026-08-06-project-rag-em-distill-fate-coverage-and-legacy-log-
...
Spec backlink: cross-repo/inbox/2026-08-06-project-rag-em-distill-fate-coverage-and-legacy-log-reader.md § 1(a)
"""
