...
skill's central/local routing pipeline (`DoE-claude coordinator/skills/
...
Port source: DoE-claude coordinator/skills/learn-lessons/SKILL.md (undated-pass fence ~L601,
