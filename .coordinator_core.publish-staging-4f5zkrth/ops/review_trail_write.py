...
# dispatched-persona reviewers (Zolí/Palí/Fru/Camelia) the coordinator routing
# table registers alongside "staff-eng" (Patrik) — roster source is
...
def _scale_shaped_scope_hint(scope: str) -> str:
    ...
    `gates.review_scale`. See cross-repo/inbox/2026-08-15-project-rag-em-
...
#: project-rag-em-wsc-review-trail-skips-silently.md. See `_scale_shaped_scope_hint`.
...
def _resolve_session_id(caller_worktree: Optional[Path] = None) -> Optional[str]:
    ...
    Extraction rationale: docs/plans/2026-07-07-makima-fork-provenance-creation-path-tooling.md § C3
    """
...
def _reserve_unique_trail_path(
    ...
    *,
    ...
    (or any other hyphen-tailed suffix): ``project-rag-ue-addon/bin/validate-artifact-
...
def _validate(
    ...
    #
    # B (cross-repo/inbox/2026-08-15-project-rag-em-wsc-review-trail-skips-
