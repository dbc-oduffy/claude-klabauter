...
Lazy op registration (F6 / makima-windows-portability § C4, made unconditional
...
Spec backlink: pln-pcore-03-beachhead-coordinator-core-fecdbb § C1b
                docs/plans/2026-07-14-makima-windows-portability.md § C4
...
_EAGER_OP_MODULES: List[Tuple[str, str]] = [
    ...
    (
        ...
        "consumed-handoff sweep; repointed at session.boot_backstop's DR-084 "
        "substrate, C5 of the same plan)",
    ),
    ...
    (
        ...
        "brightline-process-budget-for-makima.md)",
    ),
]
