...
Shard default location: this op resolves makima's OWN worktree root the same
...
T3a-g3c cutover, shards are written into makima's own checkout regardless of
