...
NEVER the `plan:` pointer (1 of 80 live handoffs carries it; C12 retires it). The join is
...
async def _predicate_refusal(
    ...
    if leg_b.applies:
        ...
        # rationale (project-opticon-em, 2026-08-05, cross-repo/inbox/2026-08-05-
        # project-opticon-em-wsc-leg-b-counts-spinoffs-as-live-children.md).
