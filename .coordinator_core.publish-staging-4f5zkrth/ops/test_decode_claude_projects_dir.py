...
def test_decode_one_claude_central_double_dash_form():
    assert _decode_one("C--Users-oduffy--claude") == ("claude-central", "c:/Users/oduffy/.claude")
...
def test_decode_one_skips_garbled_entries():
    ...
    assert _decode_one("--Users-oduffy---claude") is None
...
def test_run_positive_corpus_dedupe_and_content(tmp_path):
    ...
    assert "DroneSim\tx:/DroneSim\tX--DroneSim" in joined
    assert "claude-central\tc:/Users/oduffy/.claude\tC--Users-oduffy--claude" in joined
