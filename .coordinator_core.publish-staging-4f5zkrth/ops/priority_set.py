...
module for the resolution ladder (meta-repo detection -> makima central state).
...
This op does NOT git-commit — consistent with every other makima mutation op.
...
def _render_entry(
    ...
    made both fields externally-reachable (project-opticon's priority-intent
