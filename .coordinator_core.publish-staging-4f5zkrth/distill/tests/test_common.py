...
def test_sidecar_bare_dash_check_suffix_matches():
    # C1 (2026-07-23 makima-driven-ceremony-redesign) — confirmed real, on-disk
    # class: archive/specs/2026-07/2026-07-10-percolation-engine-makima.v3-divergence-check.md
    ...
    assert is_sidecar_filename("2026-07-10-percolation-engine-makima.v3-divergence-check.md") is True


def test_sidecar_bare_dash_review_suffix_matches():
    # C1 — confirmed real, on-disk class: reviewer-named dash-separated review
    # sidecars (patrik-review.md, sonnet-review.md, eng-director-review.md,
    # OVERVIEW.zoli-review.md) live under docs/plans/ and state/review-trail/,
    ...
    assert is_sidecar_filename("2026-07-06-makima-native-op-central-subject-delegation.eng-director-review.md") is True
