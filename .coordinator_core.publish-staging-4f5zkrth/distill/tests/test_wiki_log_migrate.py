...
makima's legacy wiki-side distill ledger (`docs/wiki/.distill-log.md`, C7). Folds every
...
## Harvested-upstream — pre-July claude-prime cohort (reclaimed to DoE, pruned 2026-07-08)

archive/specs/2026-03..06/** → harvested-upstream (distilled in DoE; see DoE `state/distillation-log.md`) — reclaimed to DoE, pruned from makima per DR `2026-07-08-reclaim-pre-july-history-from-makima`

## Harvested — 2026-07 makima cohort (run 2026-07-08-pass1)
...
archive/specs/2026-07/2026-07-04-cross-repo-memo-makima-ownership-and-standalone-service.md  # superseded by DR-210-makima-native-tooling-ownership-strangler
...
def test_migrate_wiki_log_run_id_extraction(tmp_path):
    ...
    assert (
        by_path[
            "archive/specs/2026-07/2026-07-04-cross-repo-memo-makima-ownership-and-standalone-service.md"
        ].run_id
        == FALLBACK_RUN_ID
    )
