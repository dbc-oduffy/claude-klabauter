...
2 coupled scripts (harvest-debt, memo-triage) all import this module. It carries:
  ...
  3. SIDECAR_SUFFIXES — the single named, full-suffix-anchored constant enumerating the
     ...
     is the eventual single owner of this enumeration; this constant is makima's half of that
...
DoE owns this vocabulary as a cross-repo contract; makima mirrors it here in lockstep,
...
(`.review.md`, `-check.md`, `.zoli-review.md`) is reconciled against it here (C1
of the 2026-07-23 makima-driven-ceremony-redesign plan) and is expected to adopt
...
`v3-divergence`, `patrik`, `sonnet`, `eng-director`, `zoli` — each still
