...
Negative-spec:
    This module is the probe-VERDICT envelope for the makima two-tier doctor.  It is
    ...
    of makima's own two-tier doctor. Do NOT import either module from the other.

    stdlib-only: no third-party imports anywhere in this module.

Spec backlink: pln-makima-install-doctor-system-f-537d61 § C0
"""
