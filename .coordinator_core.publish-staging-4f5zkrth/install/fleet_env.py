...
`market-intelligence/scripts/setup.py::path_wire_project_rag` — see
...
#: from `market-intelligence/scripts/setup.py::path_wire_project_rag`
#: (writes `market_intelligence_project_rag_sibling.pth`), settled prior art
...
def register_sibling_binding(
    ...
    *,
    ...
    import (market-intelligence's own documented failure mode; see contract
