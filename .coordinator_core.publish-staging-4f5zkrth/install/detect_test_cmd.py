...
# `root` is the caller-named TARGET repo (a parameter, not fixed to makima's
# own tree) -- never a fixed makima artifact.
GENERATES = []
...
WRITE_SURFACE = WriteSurfaceDeclaration(
    ...
    clauses=(
        ...
        # scoped to the makima repo itself (see module docstring: it
