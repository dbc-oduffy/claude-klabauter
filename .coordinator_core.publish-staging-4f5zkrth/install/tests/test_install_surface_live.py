...
def _resolve_real_ch_bin() -> Path:
    """`<makima_root>/coordinator/lib/claude-home` -- same resolution
    `run()` performs (`ch_bin = makima_lib / "claude-home"`), rooted at this
    checkout since this test module lives inside project-makima itself."""
