...
# (cross-repo/inbox/2026-07-28-project-rag-ue-addon-em-install-substrate-
...
def _stub_run_dependencies(monkeypatch, tmp_path):
    ...
    ch_bin = makima_root / "coordinator" / "lib" / "claude-home"
    ...
    monkeypatch.setattr(
        substrate, "coordinator_makima_root_with_class", lambda: (str(makima_root), "live-working-tree")
    )
    monkeypatch.setattr(
