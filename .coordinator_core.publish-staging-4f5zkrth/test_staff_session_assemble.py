...
the zoli-cannot-debate rejection, unknown-domain-signal / unknown-slug
...
| `pali` | `coordinator/agents/senior-front-end.md` |
| `fru` | `coordinator/agents/staff-ux.md` |
...
| `pali` | `coordinator:senior-front-end` |
| `fru` | `coordinator:staff-ux` |
"""
