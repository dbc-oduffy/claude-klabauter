...
Run: cd /Users/oduffy/X/project-makima && python3 -m pytest coordinator_core/test_sizing_assemble.py -q
"""
...
def test_write_guard_validate_frontmatter_schema_deny_accepts_real_xxl_sizing_object(
    ...
    # duty to validate against the makima-side write path
...
def test_sizing_object_schema_version_and_bump_class():
    ...
    # doe_version == makima_version assert) and only reaches the shape-hash
