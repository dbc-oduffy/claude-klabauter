...
§ C5) is the child-env propagation half of AC11: opticon's finding is that a
...
not reorder that ladder (cross-language contract, DoE's call) — what makima
...
Python-native mirror for makima-resident callers.
