...
docs/plans/2026-08-03-klabauter-rows-relocate-into-makima.md § C5/C6
...
#: (`## Dispatch Ledger — makima [M] slice`) never matched the old
...
def _stamp_rows_in_body(
    ...
    false-positive fidelity refusal reported by project-opticon-em):
...
Design-as-offers (memo, project-opticon-em 2026-08-01): leads with the ONE
