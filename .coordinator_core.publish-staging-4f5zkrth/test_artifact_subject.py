...
# ---------------------------------------------------------------------------
def test_makima_install_script_is_engine():
    assert classify("project-makima/install.sh") == Subject.ENGINE
...
# ---------------------------------------------------------------------------
# Makima-addressed memo
# ---------------------------------------------------------------------------
def test_to_project_makima_memo_is_engine():
    assert (
        classify("state/memos/to-project-makima-pcore-roadmap-q3.md")
        == Subject.ENGINE
    )
...
def test_makima_install_slug_is_engine():
    assert (
        classify("docs/plans/2026-07-04-makima-install-chain-rewire.md")
        == Subject.ENGINE
    )
