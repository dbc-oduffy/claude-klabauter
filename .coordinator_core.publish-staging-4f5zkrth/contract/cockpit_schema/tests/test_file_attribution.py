...
Pytest port of DoE `coordinator/cockpit-contract/test/file-attribution.test.ts`.
...
Spec backlinks:
  - docs/plans/2026-06-30-ccos-8-opticon-read-contract-spine-entities.md § C3, AC6
