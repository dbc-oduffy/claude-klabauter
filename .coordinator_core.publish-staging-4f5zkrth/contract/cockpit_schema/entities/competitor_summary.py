"""
CompetitorSummary — market-intelligence competitor relationship fact (Level-2).
Pydantic port of DoE `coordinator/cockpit-contract/src/entities/competitor-summary.ts`
(Zod source).

One of two entities added in the v2.16.0 widen for opticon's market-intelligence
...
class CompetitorSummary(BaseModel):
    ...
    # Natural join key (opticon keys on (repo, competitor_uid, segment)).
