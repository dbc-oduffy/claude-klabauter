...
emission shape. The exact granularity opticon needs is confirmed in the C7
opticon ask memo — if opticon requests raw rows, this aggregate can be
...
Spec backlinks:
  ...
  - docs/plans/2026-06-30-ccos-8-opticon-read-contract-spine-entities.md § C3
