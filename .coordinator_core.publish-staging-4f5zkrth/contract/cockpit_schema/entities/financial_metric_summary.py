"""
FinancialMetricSummary — market-intelligence financial fact (Level-2 aggregate),
sourced from market-intelligence's sc1-06 EDGAR XBRL quantitative-claim output.
...
bilateral by construction — DoE ratifies the shape, makima's emitter produces
...
Source of record: market-intelligence's FinancialMetricRecord
...
class FinancialMetricSummary(BaseModel):
    ...
    claim_id: str
    """market-intelligence producer-local surrogate id. Part of the natural key (repo, claim_id, content_key)."""
    content_key: str | None = Field(
        description=(
            ...
            "Nullable-present on the hosted contract; market-intelligence "
