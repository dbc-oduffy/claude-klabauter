...
as JSON Schema PROJECTIONS of makima's own cross-repo-memo SSOT, mirroring the
...
BEHAVIOR-ownership, not a hand-authored-file relocation — makima's engine
...
MEMO_SCHEMA_BUMP_NOTE = (
    ...
    "2026-08-21-project-makima-em-gate-closure-signal-contract.md, ruled by "
...
_TO_REPO_CROSS_REPO_MEMO_DESCRIPTION = (
    ...
    "`repos.<key>` form (e.g. repos.doe_claude, repos.project_makima, "
    ...
    "pre-2026-07-24 corpus and not yet emitted by makima's memo_send — "
    ...
    "project-makima-em-central-id-canonical-order.md \"Not asked for, "
...
_TO_REPO_ARCHIVED_MEMO_DESCRIPTION = (
    ...
    "extension, not (yet) emitted by makima's memo_send."
)
...
_DISCHARGES_DESCRIPTION = (
    ...
    "inbox/2026-08-21-project-makima-em-gate-closure-signal-contract.md, "
...
def _build_cross_repo_memo_schema() -> dict[str, Any]:
    ...
    (the makima-native SSOT, ported from DoE's now-superseded
    ...
    return {
        ...
        "description": (
            ...
            "not hand-vendored: makima owns the behavioral SSOT "
            "(coordinator_core.frontmatter.schema_validate._MEMO_CROSS_FIELD_RULES "
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "generated projections of makima's memo SSOT. See "
