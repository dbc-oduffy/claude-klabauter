...
Run: cd /Users/oduffy/X/project-makima && python3 -m pytest coordinator_core/test_archive_stamp.py -q
"""
...
# ---------------------------------------------------------------------------
# cs_chain_archive_handoff / cs_supersede_archive_handoff — the C8 (opticon
...
class TestSupersedeArchiveHandoff:
    ...
    def test_shipped_predecessor_with_ledger_claim_is_stamped_with_its_holder(self, tmp_path):
        ...
        Measured 2026-08-10 in project-rag: 34 of 231 archived `status: claimed`
