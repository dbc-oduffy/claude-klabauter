...
kind=spinoff: parent-discovery order is stub -> plan -> mint. Companion ids:
    ...
    cross-repo/inbox/2026-07-07-spinoff-provenance-makima-ratified.md).
...
docs/plans/2026-07-17-makima-handoff-phase-execution-emit-leg.md), which
is not this module.
...
live makima op `handoff.author_fork` (coordinator_core/ops/handoff_author_fork.py,
registered op name "handoff.author_fork") rather than reimplementing spinoff
authoring inline -- this is PENDING the makima-em seam decision (dispatch /
...
resolve_operator_config()` for settings_home/makima_root/doe_root -- this module
...
Negative-spec:
    ...
    - Do NOT assert that `handoff.author_fork` is superseded by this module --
      C0's makima-em seam decision is still open; the spinoff directive merely
...
def _scan_deliverable_collision(
    ...
    regardless of ancestry (2026-08-05 market-intelligence-em cross-repo
...
def brief(
    ...
    # cleanly -- a corrupt settings_home/makima_root/doe_root value fails
