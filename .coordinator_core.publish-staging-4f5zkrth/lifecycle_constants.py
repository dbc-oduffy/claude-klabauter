...
only for makima's own corpus, not for the consumer repos (project-rag,
project-opticon, ...) whose on-disk handoff frontmatter these ops also read,
so a makima-scoped retirement oracle is structurally insufficient. The narrow
...
surviving old tokens — not on makima's own corpus being clean.
"""
...
# that landed as commits. Ruled 2026-07-25 against a market-intelligence-em
