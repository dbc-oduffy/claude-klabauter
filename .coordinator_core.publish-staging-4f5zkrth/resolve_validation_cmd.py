...
conventional fallback — Patrik F1):
...
No first-token heuristic (Patrik F5): the resolver does NOT pre-parse, probe, or
...
This module is authored as the makima-side Python equivalent for future Python
...
def cs_resolve_fast_test_cmd(
    ...
    # Step 3 — skip-with-notice (no conventional fallback — Patrik F1)
