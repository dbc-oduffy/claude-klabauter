...
def test_d2_fires_independent_of_length_short_message(tmp_path):
    text = "Relayed to /Users/alice/X/project-makima/state/a.md and /Users/alice/X/DoE-claude/cross-repo/b.md."
...
def test_corpus_shape_10_word_reply_two_absolute_paths_fires_d2_only(tmp_path):
    text = "Relayed the memo to /Users/alice/X/project-makima/state/a.md and /Users/alice/X/DoE-claude/b.md"
    word_count = m._word_count(text)
