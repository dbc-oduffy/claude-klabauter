...
# docstring is a request. (Review: eng-director/zoli F8.)
#
...
def _plan_frontmatter(status="executing", execution_authorized_by="pm-oduffy", extra=""):
