...
Run: cd /Users/oduffy/X/project-makima && python3 -m pytest coordinator_core/test_pickup_apply.py -q
"""
...
# a synthetic-brief/CLI-level test (Patrik finding #6): no reachable artifact
...
# ---------------------------------------------------------------------------
# AC9e (b) — replaces the decorative "no subprocess import" grep (Patrik
...
class TestAlreadySatisfiedSkip:
    ...
    def test_a_second_apply_on_a_self_held_directive_set_is_a_clean_no_op(self, tmp_path):
        # AC3b (Zolí review F2): an artifact whose brief() recompute reports
...
# ---------------------------------------------------------------------------
# C2d / Zolí review F6 — disposition round-trip from the session-scoped
...
# ---------------------------------------------------------------------------
# Piece A (cross-repo/inbox/2026-08-04-market-intelligence-em-pickup-jgate-
