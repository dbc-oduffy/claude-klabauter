...
already correct: `cross-repo/inbox/2026-08-13-project-opticon-em-guard-advisories-read-
...
Negative-spec -- what this module deliberately does NOT do:
  ...
  - Does NOT ship a successful answer through the harness's error/deny channel. A
    ...
    for the answered path. `cross-repo/inbox/2026-08-13-project-opticon-em-guard-
