...
`preuse-bash-dispatch.py` fans out to -- they exist only as makima Python
...
per that contract's "Natural emitter source" section -- makima is DoE's
...
`script` / "Script tail key" sections -- this module is the makima-side
