...
def _crash_deny(guard_name: str, exc: BaseException, resolution_class: Optional[str] = None) -> Dict[str, Any]:
    ...
    ``_engine_root.resolve_makima_root_with_class()`` and feature-detects onto
    ...
    return {
        "hookSpecificOutput": {
            ...
            "permissionDecisionReason": (
                ...
                "to whoever dispatched you and open project-makima's "
...
def _evaluate_payload_json_budgeted(
    ...
    *,
    ...
    bash-dispatch.py`` (its own ``_engine_root.resolve_makima_root_with_
