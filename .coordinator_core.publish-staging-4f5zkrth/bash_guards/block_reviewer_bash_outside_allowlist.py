...
regression a fix introduced. Source: project-opticon-em cross-repo memo
``cross-repo/inbox/2026-07-25-project-opticon-em-makima-reviewer-readonly-git.md``.
...
cross-repo/archive/2026-07-25-project-makima-em-code-reviewer-sidecar-provisioning-fails-most-spawns.md,
...
_EXECUTOR_ACCEPTED_FORMS_STANZA = (
    "Accepted invocation forms (the dispatching EM resolves <makima-root> from the",
    "machine-local registry key repos.project_makima and injects the literal",
    "absolute path into the dispatch prompt -- a confined agent cannot resolve it):",
    "  <makima-root>/coordinator/bin/coordinator-doc-new.py [--plan <path>] [--chunk <id>] ...",
    "  python3 <makima-root>/coordinator/bin/coordinator-doc-new.py [--plan <path>] [--chunk <id>] ...",
)
...
_DEFAULT_ACCEPTED_FORMS_STANZA = (
    "  <makima-root>/coordinator/bin/coordinator-doc-new.py --type review-findings ...",
    "  python3 <makima-root>/coordinator/bin/coordinator-doc-new.py --type review-findings ...",
)
