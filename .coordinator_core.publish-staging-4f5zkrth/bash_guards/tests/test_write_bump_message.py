...
#: production shape (an operator-typed `/x/project-makima/...` or
#: `/c/Users/...` token) fails.
_LONG_RAW_MSYS_TOKEN = "/c/Users/oduffy/AppData/Local/Temp/claude/X--project-makima/foreign-scratch-target.txt"
_LONG_RESOLVED_NATIVE_PATH = (
    r"C:\Users\oduffy\AppData\Local\Temp\claude\X--project-makima\foreign-scratch-target.txt"
)
...
# opticon-em-guard-advisories-read-as-injection-to-subagents.md, mirroring
...
_RAW_MSYS_TOKEN = "/c/Users/oduffy/foreign/scratch.txt"
_RESOLVED_NATIVE_PATH = r"C:\Users\oduffy\foreign\scratch.txt"
