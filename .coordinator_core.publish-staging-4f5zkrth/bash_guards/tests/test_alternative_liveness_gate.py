...
#: Zoli's review (finding 5, "UNTRIGGERED is an un-ratcheted suppression
...
EXPECTED_UNVERIFIABLE_COUNTS: Dict[str, int] = {
    ...
    # `python3 <makima-root>/coordinator/bin/coordinator-doc-new.py ...` --
    # the `<makima-root>` placeholder makes this a template, not a directly
...
#: Zoli's review (finding 6, "UNVERIFIABLE is an ungated sink"): pin a
...
EXPECTED_LIVE_FLOORS: Dict[str, int] = {
    ...
    # Re-pinned 1 -> 2, 2026-08-15 (project-rag-em cross-repo memo,
