...
project-makima checkout itself -- this check's probe reads the ACTUAL
...
# ---------------------------------------------------------------------------
# Amend-ownership gate (2026-08-15, project-rag-em cross-repo memo:
# `cross-repo/inbox/2026-08-15-project-rag-em-amend-has-no-safe-helper-and-
