...
(project-makima, DoE-claude, every other sibling repo this machine tracks
...
# ---------------------------------------------------------------------------
# market-intelligence-em scoped-commit-guard-asymmetry finding (2026-08-03
...
# ---------------------------------------------------------------------------
# market-intelligence-em scoped-commit-guard-asymmetry finding: an absolute
