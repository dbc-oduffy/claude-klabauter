...
``cross-repo/archive/2026-08-10-project-rag-em-close-out-stamps-implemented-
...
classified it as prompt injection. The audited finding (project-makima,
...
memo (market-intelligence-em, plus two prior siblings): the disclaimer
...
class TestAnnotateDenyDisclaimer:
    ...
    def _fire(self, tmp_path, monkeypatch):
        ...
        return gus.annotate_deny(
            ...
            doc_display="project-makima docs/reference/guard-override-keys.md",
        )
