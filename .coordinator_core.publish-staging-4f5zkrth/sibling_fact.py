"""
coordinator_core.sibling_fact — makima-owned primitive: resolve a declarative
...
Deliberately NOT here (Patrik F9, F3; D3a, D4 of the spec backlink above):
...
REUSE, NOT RE-IMPLEMENTATION, WITHOUT THE FAIL-OPEN (Patrik F7):
...
def _resolve_frontmatter_field(path: Path, field: str) -> Tuple[bool, Optional[str], Optional[str]]:
    ...
    absent / unreadable / literal-null (Patrik F7) rather than inheriting
