...
_SELF_VERIFY_CONSTRAINT = (
    "After implementation: (1) re-read the spec's `## Acceptance Criteria` "
    "and confirm each item is implemented; (2) run `git status --porcelain "
...
def _derive_baton_count(raw: str) -> Optional[int]:
    ...
    source memo `cross-repo/inbox/2026-08-04-project-rag-em-brightline-
...
def _measure_range(repo_root: Path, range_: str) -> Optional[dict[str, int]]:
    ...
    `code_loc` (2026-08-20, cross-repo/inbox/2026-08-20-project-rag-em-
...
def _unresolved_range_judgment_point(reason: str, evidence: str) -> ReaderResult:
    ...
    `cross-repo/inbox/2026-08-04-project-rag-em-brightline-partition-
