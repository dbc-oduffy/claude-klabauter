...
written into makima's own archived copy — invisible to the sender — and
...
Run: cd /Users/oduffy/X/project-makima && python3 -m pytest coordinator_core/test_pickup_assemble_reply_closure.py -q
"""
