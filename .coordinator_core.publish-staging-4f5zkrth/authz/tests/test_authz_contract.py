...
# makes any registry-size assertion vacuously green (Patrik F0 — the vacuous-pass hazard).
...
# ---------------------------------------------------------------------------
# Drift-guard (AC4 / Patrik F0) — detect-then-fail-loud gate
#
...
class TestDriftGuard:
    ...
    def test_registry_is_non_empty(self) -> None:
        """Positive floor — a vacuously-empty registry must not pass (Patrik F0).
...
#
# Spec backlink: pln-makima-deliverable-spine-fact--cd004e § C3
# ---------------------------------------------------------------------------
...
#
# Spec backlink: pln-memo-tool-rebuild-makima-owns--bd5745 § C7
