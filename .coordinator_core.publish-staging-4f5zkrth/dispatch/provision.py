...
three decision-object fields:
  completion_status    -- durable, queryable "task done" marker; backlinks the
                           EXISTING query-completions records surface (makima
...
makima-side engine consumer it can reach directly:
...
coordinator-claude's surface, not makima's (see
...
def _yaml_quote(value: str) -> str:
    ...
    scope (this module never imports across the makima/CLI-script boundary;
