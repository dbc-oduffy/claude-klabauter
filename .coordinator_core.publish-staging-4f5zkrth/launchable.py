...
Launchable-extension-map precedent (bash/sh branch, keep-not-port):
    ...
    a dependency." Nothing on makima's own build/install/test critical path
    ...
    because nothing about makima's OWN work depends on the target actually
...
Spec backlink: ``cross-repo/archive/2026-07-20-market-intelligence-em-engine-argv-vector-script-launch-windows.md``
"""
