...
building, ownership-liveness gating — over ALREADY-NATIVE makima ops
...
subprocess hop, no strangler-facade legacy fallback) — this module IS the makima engine,
...
def cs_chain_archive_handoff(
    ...
    This is the scout-verified CLI gap opticon §6.2 flagged: 'chain' was reachable
