...
the DoE plane and engine artifacts in the makima plane.
...
Classification contract:
    ...
    engine        — artifact is ABOUT engine internals: coordinator_core/**,
                    pcore roadmap, makima's own install-chain node (NOT the
                    coordinator install skill), MCP/resident-service
                    research, memos addressed TO project-makima.
...
Install-chain disambiguation (required by spec):
    makima's own install script                       -> engine
