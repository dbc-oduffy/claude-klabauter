...
class TestMisePhase6ReviewScaleVerdict:
    ...
    def test_doc_only_mise_run_is_not_forced_into_a_mandatory_partition(
        ...
        """2026-08-20, cross-repo/inbox/2026-08-20-project-rag-em-review-gate-
...
class TestTrampolineDispatchRouting:
    ...
    def test_mint_run_id_routes_to_brief_module_main_not_main_drop(self, monkeypatch):
        # MAKIMA_ROOT set explicitly: _backlog_grind_assemble_entry re-runs
