...
of them:
  ...
  - `schema_drift_watch.scan_vendored_schema_drift` compares makima's copy to
  ...
  - `schema_validate`'s consumer-ahead gate asserts makima's
...
#: in this repository at all. makima's counterpart -- the commit that made the
